...
"Рабочее место с таким идентификатором клиента уже существует.'; en = 'Error saving workstation."
"Workstation with such customer ID already exists.'");
...
"Продолжить сохранение с указанным наименованием?'; en = 'The non-unique name of the workplace is specified."
"Perhaps later it will make it difficult to identify and select a workplace."
"It is recommended to indicate the unique name of the workplace."
"Continue saving with the specified name?'");
