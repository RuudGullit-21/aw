		...
		Если ВыполнениеРазрешено = Истина Тогда
			...
			Иначе
				ЛогШаговВыполнения.Добавить(
					НСтр("ru = 'Ошибка загрузки стандартных значений новостей из макетов. Справочник лент новостей пустой.'; en = 'An error occurred while importing standard news values from the templates. News feed catalog is empty.'"));
...
"Не найдена лента новостей с таким идентификатором.'; en = 'Error loading standard news values from layout %1."
"No news feed with this ID was found.'"),
									ТекущийМакет.Имя));
						КонецЕсли;
					КонецЕсли;
				КонецЦикла;
...
"%2'; en = 'Error loading additional standard values of news because:"
"%1"
"The first 2,000 characters of additional content:"
"%2'"),
