...
Процедура КомандаЗаписать(Команда)
	...
	Диалог.Заголовок = НСтр("ru = 'Выберите файл, куда записать содержимое XML'; en = 'Select the file where to write the XML content'");
	...
	Если (ТипЗнч(ВыбранныеФайлы) = ТипМассив)
		...
		Если НЕ ПустаяСтрока(ИмяФайла) Тогда
			...
			Если ПустаяСтрока(ЭтотОбъект.ПредставлениеXML) Тогда
				...
				ТекстСообщения = НСтр("ru = 'Текст пустой. Нечего сохранять.'; en = 'Text is empty. There is nothing to save.'");
			...
			Иначе
				...
				ПоказатьОповещениеПользователя(
					НСтр("ru = 'Файл записан.'; en = 'File is recorded.'"),
