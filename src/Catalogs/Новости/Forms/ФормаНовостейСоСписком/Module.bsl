...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ПустаяСтрока(ЭтотОбъект.ЗаголовокФормы) = Истина Тогда
		ЭтотОбъект.ЗаголовокФормы = НСтр("ru = 'Новости'; en = 'News'");
	КонецЕсли;
...
#КонецОбласти
	...
	Если ЭтотОбъект.ВремяПереносаПоказатьПозжеМинут > 0 Тогда
		Если ЭтотОбъект.ТаблицаНовостей.Количество() = 1 Тогда
			ТекстПодсказки = НСтр("ru = 'Не напоминать про эту новость %ВремяПереносаПоказатьПозжеМинут% минут'; en = 'Do not remind me about this news for %ВремяПереносаПоказатьПозжеМинут% minutes'");
		Иначе
			ТекстПодсказки = НСтр("ru = 'Не напоминать про эти новости %ВремяПереносаПоказатьПозжеМинут% минут'; en = 'Do not remind me about these pieces of news for %ВремяПереносаПоказатьПозжеМинут% minutes'");
		КонецЕсли;
