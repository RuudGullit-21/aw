...
"Данные новости:"
"УИН: %УИННовости%"
"Текст новости: %ТекстНовости%'; en = 'Before a news about system error was written, property СкрыватьВОбщемСпискеНовостей was assigned for it not to be displayed to a user."
"News data:"
"UIC: %УИННовости%"
"News text: %ТекстНовости%'");
		...
		ОбработкаНовостей.ЗаписатьСообщениеВЖурналРегистрации(
			НСтр("ru = 'БИП:Новости.Изменение данных'; en = 'ISL:News.Change data'", ОбщегоНазначения.КодОсновногоЯзыка()), // ИмяСобытия.
			НСтр("ru = 'Новости. Изменение данных. Новость. Перед записью'; en = 'News. Change data. News. Before writing'", ОбщегоНазначения.КодОсновногоЯзыка()), // ИдентификаторШага.
