...
"Поставляемый профиль уже существует:'; en = 'An error occurred when writing profile ""%1""."
"This profile already exists:'"),
			Наименование);
		
		ПодробноеПредставлениеОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Ошибка при записи профиля ""%1""."
"Идентификатор поставляемых данных ""%2"" уже используется в профиле:'; en = 'An error occurred when writing profile ""%1""."
"Identifier ""%2"" of provided data is already in use in the profile:'"),
			Наименование,
		...
		Иначе
			ЗаписьЖурналаРегистрации(
				НСтр("ru = 'Управление доступом.Нарушение однозначности поставляемого профиля'; en = 'Access management.Violation of unambiguity of the supplied profile'",
