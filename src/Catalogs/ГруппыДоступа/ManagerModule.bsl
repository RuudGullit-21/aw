	...
	Попытка
		...
		Иначе
			ГруппаДоступаПоНаименованию = ГруппаДоступаПоНаименованию(
				НСтр("ru = 'Администраторы'; en = 'Администраторы'", ОбщегоНазначения.КодОсновногоЯзыка()));
		...
		ГруппаДоступаОбъект.Наименование = НСтр("ru = 'Администраторы'; en = 'Администраторы'",
...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	Элемент.Наименование = НСтр("ru = 'Администраторы'; en = 'Администраторы'", ОбщегоНазначения.КодОсновногоЯзыка());
