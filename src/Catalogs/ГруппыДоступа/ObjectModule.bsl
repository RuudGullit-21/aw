...
"либо при наличии роли ""Полные права"".'; en = 'Predefined access group Administrators"
"can be changed either in privileged mode,"
"or if you have the ""Full Rights"" role.'");
		КонецЕсли;
...
"группы внешних пользователей недопустимы.'; en = 'Predefined Access Group Administrators"
...
"at predefined access group Administrators.'");
	КонецЕсли;
