	...
	Если Параметры.РежимВыбора Тогда
		...
		Если Параметры.ЗакрыватьПриВыборе = Ложь Тогда
			...
			Если ХранимыеПараметры.РасширенныйПодбор Тогда
				...
				Элементы.ЗавершитьИЗакрыть.Заголовок = НСтр("ru = 'Завершить и закрыть'; en = 'End and close'");
			КонецЕсли;
...
Процедура ИзменитьПараметрыРасширеннойФормыПодбора()
	...
	ИначеЕсли ПолучитьФункциональнуюОпцию("ИспользоватьГруппыПользователей") Тогда
		...
		Элементы.ПользователиСписок.Заголовок                    = НСтр("ru = 'Пользователи в группе'; en = 'Users in group'");
	...
	Если Параметры.РежимВыбора Тогда
		...
		Если Параметры.ЗакрыватьПриВыборе = Ложь Тогда
			...
			Если ВыборГруппПользователей Тогда
				...
				Иначе
					Заголовок = НСтр("ru = 'Подбор пользователей и групп'; en = 'Select users and groups'");
				КонецЕсли;
				
				ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы,
					"ВыбратьПользователя", "Заголовок", НСтр("ru = 'Выбрать пользователей'; en = 'Select users'"));
				
				ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы,
					"ВыбратьГруппуПользователей", "Заголовок", НСтр("ru = 'Выбрать группы'; en = 'Selected groups'"));
			Иначе
				...
				Иначе
					Заголовок = НСтр("ru = 'Подбор пользователей'; en = 'Pick users'");
				КонецЕсли;
		...
		Иначе
			...
			Если ВыборГруппПользователей Тогда
				...
				ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы,
					"ВыбратьПользователя", "Заголовок", НСтр("ru = 'Выбрать пользователя'; en = 'Select user'"));
			Иначе
