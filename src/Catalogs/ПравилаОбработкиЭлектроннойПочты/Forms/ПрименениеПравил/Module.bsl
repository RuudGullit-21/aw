...
Процедура Применить(Команда)
	...
	Если ДляПисемВПапке.Пустая() Тогда
		ОбщегоНазначенияКлиент.СообщитьПользователю(
			НСтр("ru = 'Не выбрана папка к письмам которой будут применены правила'; en = 'Folder to which emails rules will be applied is not selected'"),,"ДляПисемВПапке");
		Отказ = Истина;
	КонецЕсли;
...
Функция ПрименитьПравилаНаСервере()
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = НСтр("ru = 'Применение правил'; en = 'Apply rules'") + " ";
