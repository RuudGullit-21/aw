...
Процедура НастроитьОтображениеНаборов()
	...
	Если ЭтоНаборыДополнительныхСведений Тогда
		Заголовок = НСтр("ru = 'Дополнительные сведения'; en = 'Additional information'");
		
		КомандаСоздать.Подсказка          = НСтр("ru = 'Создать уникальное сведение'; en = 'Create unique information'");
		КомандаСоздать.Заголовок          = НСтр("ru = 'Новое'; en = 'New'");
		КомандаСоздать.Подсказка          = НСтр("ru = 'Создать уникальное сведение'; en = 'Create unique information'");
		
		КомандаСкопировать.Подсказка        = НСтр("ru = 'Создать новое сведение копированием текущего'; en = 'Create new data by copying an existing one'");
		КомандаИзменить.Подсказка           = НСтр("ru = 'Изменить (или открыть) текущее сведение'; en = 'Change (or open) current data'");
		КомандаПометитьНаУдаление.Подсказка = НСтр("ru = 'Пометить текущее сведение на удаление (Del)'; en = 'Mark current information for deletion (Del)'");
		КомандаПереместитьВверх.Подсказка   = НСтр("ru = 'Переместить текущее сведение вверх'; en = 'Move current data up'");
		КомандаПереместитьВниз.Подсказка    = НСтр("ru = 'Переместить текущее сведение вниз'; en = 'Move current data down'");
		...
		Элементы.СвойстваТипЗначения.Подсказка =
			НСтр("ru = 'Типы значения, которое можно ввести при заполнении сведения.'; en = 'Value types that can be entered on filling in the information.'");
		
		Элементы.СвойстваОбщиеЗначения.Подсказка =
			НСтр("ru = 'Сведение использует список значений сведения-образца.'; en = 'Information uses sample list of values.'");
...
"нескольких наборах дополнительных сведений.'; en = 'Common additional information which is used"
"in several sets of additional information.'");
	Иначе
		...
		КомандаСоздать.Подсказка          = НСтр("ru = 'Создать уникальный реквизит'; en = 'Create unique attribute'");
		...
		Элементы.СвойстваТипЗначения.Подсказка =
			НСтр("ru = 'Типы значения, которое можно ввести при заполнении реквизита.'; en = 'Types of values that can be entered on filling in the attribute.'");
		
		Элементы.СвойстваОбщиеЗначения.Подсказка =
			НСтр("ru = 'Реквизит использует список значений реквизита-образца.'; en = 'The attribute uses a value list of attribute-sample.'");
...
"нескольких наборах дополнительных реквизитов.'; en = 'Common additional attribute which is used"
	...
	Если Элементы.Свойства.ТекущиеДанные <> Неопределено Тогда
		...
		Если ЭтоНаборыДополнительныхСведений Тогда
			...
			ИначеЕсли Элементы.Свойства.ТекущиеДанные.ПометкаУдаления Тогда
				ТекстВопроса = НСтр("ru = 'Снять с текущего сведения пометку на удаление?'; en = 'Clear mark for deletion for the current information?'");
			Иначе
				ТекстВопроса = НСтр("ru = 'Пометить текущее сведение на удаление?'; en = 'Mark current information for deletion?'");
			КонецЕсли;
		Иначе
			Если Не ПоказатьНеиспользуемыеРеквизиты Тогда
			...
			ИначеЕсли Элементы.Свойства.ТекущиеДанные.ПометкаУдаления Тогда
				ТекстВопроса = НСтр("ru = 'Снять с текущего реквизита пометку на удаление?'; en = 'Clear mark for deletion for the current attribute?'");
			Иначе
				ТекстВопроса = НСтр("ru = 'Пометить текущий реквизит на удаление?'; en = 'Mark the current attribute for deletion?'");
			КонецЕсли;
		КонецЕсли;
...
""
"Повторите действие, если требуется.'; en = 'The action is not executed as additional information"
...
""
"Повторите действие, если требуется.'; en = 'The action is not executed as additional attributes"
