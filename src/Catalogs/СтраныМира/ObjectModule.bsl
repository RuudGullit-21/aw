	...
	Пока Выборка.Следующий() Цикл
		...
		Если СтрСравнить(Выборка.Код, Код) = 0 Тогда
			...
			Сообщение.ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'С кодом %1 уже существует страна %2. Измените код или используйте уже существующие данные.'; en = 'Country %2 with code %1 already exists. Change the code or use the existing data.'"),
