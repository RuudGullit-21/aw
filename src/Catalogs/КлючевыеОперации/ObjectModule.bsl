...
Процедура ПроверитьПриоритет(Отказ)
	...
	Если Выборка.Следующий() Тогда
		ТекстСообщения = НСтр("ru = 'Ключевая операция с приоритетом ""%1"" уже существует (%2).'; en = 'The key operation with priority ""%1"" already exists (""%2"").'");
		...
		ЗаписьЖурналаРегистрации(НСтр("ru = 'Оценка производительности'; en = 'Performance evaluation'", ОбщегоНазначения.КодОсновногоЯзыка()),
