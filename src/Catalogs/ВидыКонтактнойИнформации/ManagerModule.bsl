...
// Функция - Возможность замены элементов
//
// Параметры:
//  ПарыЗамен		 - Соответствие - см. ПоискИУдалениеДублейПереопределяемый.ПриОпределенииВозможностиЗаменыЭлементов.ПарыЗамен
//  ПараметрыЗамены	 - Структура - см. ПоискИУдалениеДублейПереопределяемый.ПриОпределенииВозможностиЗаменыЭлементов.ПараметрыЗамены
// 
// Возвращаемое значение:
//   - Структура - см. ПоискИУдалениеДублейПереопределяемый.ПриОпределенииВозможностиЗаменыЭлементов.НедопустимыеЗамены
//
...
// Процедура - Параметры поиска дублей
//
// Параметры:
//  ПараметрыПоиска			 - Структура - см. ПоискИУдалениеДублейПереопределяемый.ПриОпределенииПараметровПоискаДублей.ПараметрыПоиска
//  ДополнительныеПараметры	 - Структура - см. ПоискИУдалениеДублейПереопределяемый.ПриОпределенииПараметровПоискаДублей.ДополнительныеПараметры 
//
...
// Процедура - При поиске дублей
//
// Параметры:
//  ТаблицаКандидатов		 - ТаблицаЗначений - см. ПоискИУдалениеДублейПереопределяемый.ПриПоискеДублей.ТаблицаКандидатов
//  ДополнительныеПараметры	 - Структура - см. ПоискИУдалениеДублейПереопределяемый.ПриПоискеДублей.ДополнительныеПараметры
//
...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	Иначе
		Элемент.Наименование = НСтр("ru = 'Контактная информация справочника ""Пользователи""'; en = 'Контактная информация справочника ""Пользователи""'", 
	...
	Иначе
		Элемент.Наименование = НСтр("ru = 'Электронная почта'; en = 'Email'", ОбщегоНазначения.КодОсновногоЯзыка());
	КонецЕсли;
	...
	Иначе
		Элемент.Наименование = НСтр("ru = 'Телефон'; en = 'Phone number'", ОбщегоНазначения.КодОсновногоЯзыка());
	КонецЕсли;
