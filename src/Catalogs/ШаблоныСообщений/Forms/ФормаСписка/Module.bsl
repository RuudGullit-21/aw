...
Процедура ИнициализироватьОтборы()
	...
	ВидыШаблонов.Вставить(0, НСтр("ru = 'Электронных писем и SMS'; en = 'Emails and SMS messages'"), НСтр("ru = 'Электронных писем и SMS'; en = 'Emails and SMS messages'"));
	...
	Назначение = "";
	ШаблонДля = НСтр("ru = 'Электронных писем и SMS'; en = 'Emails and SMS messages'");
