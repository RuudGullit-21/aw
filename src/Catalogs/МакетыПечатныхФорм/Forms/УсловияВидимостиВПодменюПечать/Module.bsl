...
Функция ПредставленияВидовСравнения()
	...
	Результат.Вставить("Равно", НСтр("ru = 'Равно'; en = 'Equal'"));
	Результат.Вставить("НеРавно", НСтр("ru = 'Не равно'; en = 'Not equal'"));
	Результат.Вставить("Заполнено", НСтр("ru = 'Заполнено'; en = 'Filled'"));
	Результат.Вставить("НеЗаполнено", НСтр("ru = 'Не заполнено'; en = 'Not filled in'"));
	Результат.Вставить("ВСписке", НСтр("ru = 'В списке'; en = 'из списка'"));
	Результат.Вставить("НеВСписке", НСтр("ru = 'Не в списке'; en = 'Not in the list'"));
