...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЭтоНовый
		...
		Наименование = НСтр("ru = 'Сценарий синхронизации для %1'; en = 'Synchronization script for %1'");
...
"Выберите другой тип данных.'; en = 'Data of the selected type cannot be used in this form."
...
Процедура ВыполнитьОбменДаннымиНаКлиенте()
	...
	Если НомерОбрабатываемойСтроки > КоличествоСтрок Тогда // выход из рекурсии
		...
		Состояние(НСтр("ru = 'Данные синхронизированы.'; en = 'Data is synchronized.'"), ?(ВыводитьСостояние, 100, Неопределено));
		Возврат; // выходим
	КонецЕсли;
