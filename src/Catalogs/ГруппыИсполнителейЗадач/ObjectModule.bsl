...
Процедура ПередЗаписью(Отказ)
	...
	Если ЗначениеЗаполнено(РольИсполнителя) Тогда
		...
		КонецЕсли;
	Иначе
		Наименование = НСтр("ru = 'Без ролевой адресации'; en = 'Without role addressing'");
	КонецЕсли;
...
"и дополнительный объект адресации ""%3""'; en = 'There is already the task performer group for whom"
"performer role ""%1"","
