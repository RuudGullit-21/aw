...
Функция СформироватьСписокТекущихДелВФоне()
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = НСтр("ru = 'Обновление списка текущих дел'; en = 'Update current to-dos'");
	...
	ИначеЕсли Результат.Статус = "Выполнено" Тогда
		...
		Если ВыводитьОповещения Тогда
			...
			Для Каждого ДелоСОповещением Из ДелаСОповещением Цикл
				...
				ПоказатьОповещениеПользователя(НСтр("ru = 'Текущие дела'; en = 'Current to-dos'"),
...
Процедура СоздатьЗаголовок(Дело, Группа, РазделСвернут)
	...
	Элемент.Подсказка = НСтр("ru = 'Развернуть/свернуть раздел'; en = 'Expand/collapse section'");
