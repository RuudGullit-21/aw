...
Процедура УстановитьСклоненияПараметровПрописи(Форма)
	...
	Если Форма.ЦелаяЧастьРод = "ж" Тогда
		Элементы.ЦелаяЧастьОдин.Заголовок = НСтр("ru = 'Одна'; en = 'One'");
		Элементы.ЦелаяЧатьДва.Заголовок = НСтр("ru = 'Две'; en = 'Two'");
	ИначеЕсли Форма.ЦелаяЧастьРод = "м" Тогда
		Элементы.ЦелаяЧастьОдин.Заголовок = НСтр("ru = 'Один'; en = 'One'");
		Элементы.ЦелаяЧатьДва.Заголовок = НСтр("ru = 'Два'; en = 'Two'");
	Иначе
		Элементы.ЦелаяЧастьОдин.Заголовок = НСтр("ru = 'Одно'; en = 'One'");
		Элементы.ЦелаяЧатьДва.Заголовок = НСтр("ru = 'Два'; en = 'Two'");
	КонецЕсли;
	
	Если Форма.ДробнаяЧастьРод = "ж" Тогда
		Элементы.ДробнаяЧастьОдин.Заголовок = НСтр("ru = 'Одна'; en = 'One'");
		Элементы.ДробнаяЧастьДва.Заголовок = НСтр("ru = 'Две'; en = 'Two'");
	ИначеЕсли Форма.ДробнаяЧастьРод = "м" Тогда
		Элементы.ДробнаяЧастьОдин.Заголовок = НСтр("ru = 'Один'; en = 'One'");
		Элементы.ДробнаяЧастьДва.Заголовок = НСтр("ru = 'Два'; en = 'Two'");
	Иначе
		Элементы.ДробнаяЧастьОдин.Заголовок = НСтр("ru = 'Одно'; en = 'One'");
		Элементы.ДробнаяЧастьДва.Заголовок = НСтр("ru = 'Два'; en = 'Two'");
	КонецЕсли;
