...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не РежимРедактирования Тогда
		ЗаголовокСтрока = ЗаголовокСтрока + " " + НСтр("ru = '(только просмотр)'; en = '(view only)'");
	КонецЕсли;
...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	Если ЗавершениеРаботы Тогда
		ТекстПредупреждения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Изменения в файле ""%1"" будут потеряны.'; en = 'Changes in the file ""%1"" will be lost.'"), ИмяИРасширение);
		Возврат;
	КонецЕсли;
...
"Сохранить изменения?'; en = 'File ""%1"" was changed."
"Save changes?'"), 
		ИмяИРасширение);
	Кнопки = Новый СписокЗначений;
	Кнопки.Добавить("Сохранить", НСтр("ru = 'Сохранить'"));
	Кнопки.Добавить("НеСохранять", НСтр("ru = 'Не сохранять'; en = 'Do not save'"));
	...
	ПараметрыНапоминания.Вставить("Заголовок", НСтр("ru = 'Внимание'; en = 'Warning'"));
...
Процедура СохранитьКак(Команда)
	...
	Фильтр = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru = 'Все файлы (*.%1)|*.%1'; en = 'All files (*.%1)|*.%1'"), РасширениеФайла());
	...
	Если ВыборФайла.Выбрать() Тогда
		...
		ПоказатьОповещениеПользователя(НСтр("ru = 'Файл успешно сохранен'; en = 'The file was successfully saved'"), , ВыбранноеПолноеИмяФайла);
