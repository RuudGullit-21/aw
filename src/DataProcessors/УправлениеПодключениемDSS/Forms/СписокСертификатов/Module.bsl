...
Процедура Удалить(Команда)
	...
	Если НЕ ЭтоСертификаты(РежимВыбора) Тогда
		...
		СписокКоманд.Добавить("Да", НСтр("ru = 'Да'; en = 'Yes'"));
		СписокКоманд.Добавить("Нет", НСтр("ru = 'Нет'; en = 'No'"));
...
Процедура УправлениеФормой(КонтекстФормы)
	...
	Иначе
		...
		ЭлементыФормы.ТаблицаСертификатовИздатель.Заголовок = НСтр("ru = 'Владелец'; en = 'Owner'");
