...
Процедура УправлениеФормой(КонтекстФормы)
	...
	ЭлементыФормы.Пароль.ПодсказкаВвода = ?(ВидимостьПароля, "", НСтр("ru = 'Не требуется'; en = 'Not required'"));
...
Процедура ОбновитьДанныеСсылок()
	...
	Если Выборка.Следующий() Тогда
		...
		ОбщаяСтрока = "<a href = """ + АдресЛичногоКабинета + """" + ">" + НСтр("ru = 'Открыть'; en = 'Open'", КодЯзыка) + "</a>";
