...
Процедура ПодготовитьФорму()
	...
	ДобавитьРазделПроверки("Сертификат", НСтр("ru = 'Сертификат'; en = 'Certificate'", КодЯзыка));
	ДобавитьРазделПроверки("Зашифровать", НСтр("ru = 'Зашифровать'; en = 'Encrypt'", КодЯзыка));
	ДобавитьРазделПроверки("Расшифровать", НСтр("ru = 'Расшифровать'; en = 'Explanation'", КодЯзыка));
	ДобавитьРазделПроверки("Подписать", НСтр("ru = 'Подписание'; en = 'Signing'", КодЯзыка));
	ДобавитьРазделПроверки("Прочее", НСтр("ru = 'Прочее'; en = 'Other'", КодЯзыка));
