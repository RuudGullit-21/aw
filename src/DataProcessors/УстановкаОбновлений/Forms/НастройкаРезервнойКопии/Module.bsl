...
Процедура ПолеКаталогРезервнойКопииНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Диалог.Заголовок = НСтр("ru = 'Выбор каталога резервной копии ИБ'; en = 'Select an infobase backup directory'");
...
Процедура КомандаОК(Команда)
	...
	Если Объект.СоздаватьРезервнуюКопию = 2 Тогда
		...
		Если Отказ Тогда
			ПоказатьПредупреждение(, НСтр("ru = 'Укажите существующий каталог для сохранения резервной копии ИБ.'; en = 'Specify an existing directory to save the IB backup.'"));
