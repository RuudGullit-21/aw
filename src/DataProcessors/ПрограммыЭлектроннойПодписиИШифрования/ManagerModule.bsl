...
Процедура ОбновитьНаименованиеВстроенногоКриптопровайдера() Экспорт
	...
	Запрос.УстановитьПараметр("Наименование", НСтр("ru = 'Облачный сервис'; en = 'Cloud service'"));
	Выборка = Запрос.Выполнить().Выбрать();
...
Функция ПредставленияСвойствСубъектаСертификата() Экспорт
	...
	ПредставленияСвойств["ОГРН"] = НСтр("ru = 'ОГРН'; en = 'MSRN'");
	ПредставленияСвойств["ОГРНИП"] = НСтр("ru = 'ОГРНИП'; en = 'OGRNIE'");
	ПредставленияСвойств["СНИЛС"] = НСтр("ru = 'СНИЛС'; en = 'IIAN'");
	ПредставленияСвойств["ИНН"] = НСтр("ru = 'ИНН'; en = 'TIN'");
	ПредставленияСвойств["ИННЮЛ"] = НСтр("ru = 'ИНН ЮЛ'");
	ПредставленияСвойств["Фамилия"] = НСтр("ru = 'Фамилия'; en = 'Last name'");
