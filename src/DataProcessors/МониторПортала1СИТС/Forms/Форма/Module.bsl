...
Функция МаркированныйСписокСПериодами(ДанныеСписка, СписокСервисов1С)
	...
	Для ИндексЭлемента = 0 По СписокДоговоров.ВГраница() Цикл
		...
		ЧастиСтроки.Добавить(
			...
			+ ?(СписокСервисов1С, НСтр("ru = 'до'; en = 'to'"), НСтр("ru = 'по'"))
			+ " "
...
Процедура ОтобразитьСостояниеОшибка(
	...
	Иначе
		Элементы.ДекорацияОшибкаЗаголовок.Заголовок = НСтр("ru = 'Ошибка'; en = 'Error'");
...
Функция НовыйТаблицаСсылкиСмТакже()
	...
	СтрокаСсылки.Заголовок = НСтр("ru = 'Портал 1С:ИТС'; en = '1C:ITS portal'");
...
Функция ЗаголовокДоступноОбновлениеПрограммы()
	Возврат НСтр("ru = 'Доступно обновление программы'; en = 'Program update is available'");
КонецФункции
