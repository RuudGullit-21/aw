...
Процедура ОбновитьТекстПоясняющейНадписи()
	...
	Если МассивОтмеченныхЭлементовСписка.Количество() = 0 Тогда
		...
		ПоясняющаяНадпись = НСтр("ru = 'Сопоставление будет выполнено только по внутренним идентификаторам объектов.'; en = 'Objects will be mapped only by internal identifiers.'");
		
	Иначе
		
		ПоясняющаяНадпись = НСтр("ru = 'Сопоставление будет выполнено по внутренним идентификаторам объектов и по выбранным полям.'; en = 'Objects will be mapped by internal identifiers and selected fields.'");
