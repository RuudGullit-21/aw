...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ЗначениеЗаполнено(Объект.УзелИнформационнойБазы) Тогда
		Текст = НСтр("ru = 'Настройка обмена данными не найдена.'; en = 'Data exchange setting is not found.'");
...
Процедура ДополнительнаяРегистрацияПередУдалением(Элемент, Отказ)
	...
	Если Количество>1 Тогда
		ТекстПредставления = НСтр("ru = 'выбранные строки'; en = 'Selected lines'");
	...
	ТекстВопроса = НСтр("ru = 'Удалить из дополнительных данных %1 ?'; en = 'Delete from additional data %1 ?'");    
...
Процедура НастройкиОтборов(Команда)
	...
	Текст = НСтр("ru = 'Сохранить текущую настройку...'; en = 'Saving the current configuration...'");
...
Функция ОбновитьКоличествоСервер()
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = 
		НСтр("ru = 'Расчет количества объектов для отправки при синхронизации'; en = 'Calculating the number of objects to be sent during synchronization'");
