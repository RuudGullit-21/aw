...
Процедура ЗагрузитьИзФайла(Команда)
	...
	#Если НЕ ВебКлиент Тогда
		...
		ПараметрыЗагрузки.Диалог.Заголовок = НСтр("ru = 'Укажите файл'; en = 'Specify file'");
...
Процедура ЗаполнитьБыстрыеОтборы(Знач ОписаниеОбработчиков = Неопределено)
	...
	ДобавитьБыстрыйОтбор(ОписаниеОбработчиков, МассивСтрок, "РежимВыполнения", НСтр("ru = 'Монопольно'; en = 'Exclusive'"));
	...
	ДобавитьПрочийБыстрыйОтбор(ОписаниеОбработчиков, "РежимВыполненияОтложенныхОбработчиков", НСтр("ru = 'Параллельно'; en = 'Parallel'"));
	ДобавитьПрочийБыстрыйОтбор(ОписаниеОбработчиков, "РежимВыполненияОтложенныхОбработчиков", НСтр("ru = 'Последовательно'; en = 'Sequentially'"));
	ДобавитьПрочийБыстрыйОтбор(ОписаниеОбработчиков, "НачальноеЗаполнение", НСтр("ru = 'Начальное заполнение'; en = 'Initial filling'"));
	ДобавитьПрочийБыстрыйОтбор(ОписаниеОбработчиков, "ВыполнятьВГруппеОбязательных", НСтр("ru = 'Обязательный'; en = 'Required'"));
	...
	ТекстСтатуса = НСтр("ru = 'Прочие'; en = 'Other'");
...
Процедура УстановитьБыстрыйОтбор(ИмяБыстрогоОтбора)
	...
	ИначеЕсли ИмяБыстрогоОтбора = НСтр("ru = 'Монопольно'; en = 'Exclusive'") Тогда
		Отбор = Новый Структура("РежимВыполнения", НСтр("ru = 'Монопольно'; en = 'Exclusive'"));
		
	ИначеЕсли ИмяБыстрогоОтбора = НСтр("ru = 'Оперативно'") Тогда
		Отбор = Новый Структура("РежимВыполнения", НСтр("ru = 'Оперативно'"));
		
	ИначеЕсли ИмяБыстрогоОтбора = НСтр("ru = 'Последовательно'; en = 'Sequentially'") Тогда
		Отбор = Новый Структура("РежимВыполненияОтложенныхОбработчиков", НСтр("ru = 'Последовательно'; en = 'Sequentially'"));
		
	ИначеЕсли ИмяБыстрогоОтбора = НСтр("ru = 'Параллельно'; en = 'Parallel'") Тогда
		Отбор = Новый Структура("РежимВыполненияОтложенныхОбработчиков", НСтр("ru = 'Параллельно'; en = 'Parallel'"));
		
	ИначеЕсли СтрНайти(ИмяБыстрогоОтбора, НСтр("ru = 'Начальное заполнение'; en = 'Initial filling'")) > 0 Тогда
	...
	ИначеЕсли СтрНайти(ИмяБыстрогоОтбора, НСтр("ru = 'Обязательный'; en = 'Required'")) > 0 Тогда
