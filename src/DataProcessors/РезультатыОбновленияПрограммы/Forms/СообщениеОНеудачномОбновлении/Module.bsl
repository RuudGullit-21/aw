...
""
"%1'; en = 'An error occurred during application version update:"
""
"%1'"),
...
Процедура ОткрытьВнешнююОбработкуПослеПодтвержденияБезопасности(Результат, ДополнительныеПараметры) Экспорт
	...
	ПараметрыЗагрузки.Диалог.Фильтр = НСтр("ru = 'Внешняя обработка'; en = 'External processing'") + "(*.epf)|*.epf";
	ПараметрыЗагрузки.Диалог.МножественныйВыбор = Ложь;
	ПараметрыЗагрузки.Диалог.Заголовок = НСтр("ru = 'Выберите внешнюю обработку'; en = 'Select external data processor'");
...
Процедура ОбработатьРезультат(Результат, ДополнительныеПараметры) Экспорт
	...
	Если РезультатУстановки.Ошибка Тогда
		...
		Кнопки.Добавить("ЖурналРегистрации", НСтр("ru = 'Журнал регистрации'; en = 'Event log'"));
