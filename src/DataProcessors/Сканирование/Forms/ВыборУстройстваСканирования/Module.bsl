...
Процедура ПриОткрытии(Отказ)
	...
	Если КоличествоЭлементов = 0 Тогда
		Отказ = Истина;
		ПоказатьПредупреждение(, НСтр("ru = 'Не установлен сканер. Обратитесь к администратору программы.'; en = 'Scanner is not installed. Contact the application administrator.'"));
	Иначе
...
Процедура ВыбратьСканер(Команда)
	...
	Если ПустаяСтрока(ИмяУстройства) Тогда
		ТекстСообщения = НСтр("ru = 'Не выбран сканер.'; en = 'Scanner is not selected.'");
