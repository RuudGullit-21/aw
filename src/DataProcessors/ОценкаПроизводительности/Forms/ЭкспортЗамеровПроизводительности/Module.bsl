...
"Экспорт невозможен.'; en = 'Parameter value ""Start date"" is greater or equal values parameters ""End date""."
"Export impossible.'");
        СообщениеПользователю.Сообщить();
    ...
    Иначе
        СообщениеПользователю = Новый СообщениеПользователю;
        СообщениеПользователю.Текст = НСтр("ru = 'За указанный период нет замеров. Файл архива не сформирован.'; en = 'A specified period is of no measurements. Archive file is not formed.'") + Символы.ПС;
        СообщениеПользователю.Сообщить();
    КонецЕсли;
