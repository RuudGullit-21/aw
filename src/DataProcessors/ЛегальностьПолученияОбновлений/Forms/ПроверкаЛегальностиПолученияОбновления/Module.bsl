...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не Параметры.ПрограммноеОткрытие Тогда
		ВызватьИсключение
			НСтр("ru = 'Обработка не предназначена для непосредственного использования.'; en = 'Data processor is not intended for direct usage.'");
	КонецЕсли;
	...
	// {УАТ}
	уатОбщегоНазначения.ИзменитьПолучателяСтатисики(ЭтаФорма, "РазрешитьОтправкуСтатистики");
	// {/УАТ}
