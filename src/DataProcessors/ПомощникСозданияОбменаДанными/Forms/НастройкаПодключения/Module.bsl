...
Функция Подключаемый_СтраницаОбщиеНастройкиСинхронизации_ПриПереходеДалее(Отказ)
	...
	Если Не ВидПодключения = "ПассивныйРежим" Тогда
		...
		Если ДоступноИзменениеНаименования
			...
			ОбщегоНазначенияКлиент.СообщитьПользователю(
				НСтр("ru = 'Укажите наименование этой программы.'; en = 'Specify this application name.'"),
				, "Наименование", , Отказ);
		КонецЕсли;
		...
		Если ДоступноИзменениеПрефикса
			...
			ОбщегоНазначенияКлиент.СообщитьПользователю(
				НСтр("ru = 'Укажите префикс этой программы.'; en = 'Specify the prefix of the programme.'"),
				, "Префикс", , Отказ);
		КонецЕсли;
