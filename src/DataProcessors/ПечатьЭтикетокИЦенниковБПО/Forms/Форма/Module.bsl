...
Процедура Печать(Команда)
	...
	Для Каждого ТекСтрока Из Товары Цикл
		Если ТекСтрока.Выбран И (НЕ ЗначениеЗаполнено(ТекСтрока.НоменклатураБПО)
			...
			ПоказатьПредупреждение(, НСтр("ru = 'В одной или нескольких строках не указана Номенклатура или Шаблон этикетки'"));
			Возврат;
		КонецЕсли;
	КонецЦикла;
	// {/УАТ}
...
Процедура УстановитьВидимостьИДоступностьЭлементовФормы()
	...
	// {УАТ}
	УстановитьВидимостьИДоступностьЭлементовФормыПечатьЭтикеток();
	// {/УАТ}
	
КонецПроцедуры

&НаСервере
Процедура УстановитьВидимостьИДоступностьЭлементовФормыПечатьЭтикеток()
