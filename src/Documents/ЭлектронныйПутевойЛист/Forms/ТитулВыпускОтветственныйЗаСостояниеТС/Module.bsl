...
Процедура ВыбратьОтветственного_Завершение(Значение, ТекущаяСтрока) Экспорт
	...
	Если Значение <> Неопределено Тогда  
		...
		ТитулВыпускОтветственныйЗаСостояниеТСФамилия = РеквизитыКонтрагента.Фамилия;
		ТитулВыпускОтветственныйЗаСостояниеТСИмя = РеквизитыКонтрагента.Имя;
		ТитулВыпускОтветственныйЗаСостояниеТСОтчество = РеквизитыКонтрагента.Отчество;
	КонецЕсли;
