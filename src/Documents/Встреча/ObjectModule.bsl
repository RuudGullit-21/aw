...
// Процедура - Заполнить наборы значений доступа
//
// Параметры:
//  Таблица	 - ТаблицаЗначений - Таблица с наборами значений доступа
//
...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если ДатаОкончания < ДатаНачала Тогда
		...
		ОбщегоНазначения.СообщитьПользователю(
			НСтр("ru = 'Дата окончания не может быть меньше даты начала.'; en = 'The end date cannot be earlier than the start date.'"),
			,
			"ДатаОкончания",
			,
			Отказ);
