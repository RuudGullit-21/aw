...
&НаКлиенте
Процедура ЗаполнитьТитулГрузоотправителяДокументПодвержденияПолномочийНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
...
Процедура ТитулГрузоотправителяУполномоченныеЛицаВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если Поле.Имя = "ЗаполнитьТитулГрузоотправителяДокументПодвержденияПолномочий" Тогда
...
Процедура ТитулГрузоотправителяУполномоченныеЛицаПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
	...
	ТекущиеДанные = Элемент.ТекущиеДанные;
	ТекущиеДанные.ЗаполнитьТитулГрузоотправителяДокументПодвержденияПолномочий = "Заполнить";
