...
Процедура Вставить(Команда)
	...
	Если ПустаяСтрока(АдресПубликацииИнформационнойБазыВИнтернете) Тогда
		...
		ТекстСообщения = НСтр("ru = 'Не указан адрес публикации информационной базы в интернете.'; en = 'Infobase publication address on the Internet is not specified.'");
	...
	Если ПустаяСтрока(СсылкаНаОбъект) Тогда
		...
		ТекстСообщения = НСтр("ru = 'Не указана внутренняя ссылка на объект.'; en = 'Internal reference to the object is not specified.'");
