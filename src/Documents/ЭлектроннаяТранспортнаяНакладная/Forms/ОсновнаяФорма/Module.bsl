...
Процедура Проверить(Команда)
	...
	Иначе 
		...
		Если ОбменСГИСЭПДКлиент.ЗаполнитьТаблицуОшибокЭПД(ЭтотОбъект, ОшибкиЗаполнения, ОчищатьТаблицу) = Истина Тогда	
...
Процедура ПредставлениеТитулУказаниеПереадресАдресВыгрузкиОбработкаВыбора(Элемент, Результат, СтандартнаяОбработка)
	...
	//ОбменСГИСЭПДКлиентСервер.ИзменитьОформлениеАдреса(ЭтотОбъект, Элемент.Имя);
...
Процедура ХранимыеДанныеТитулГрузоотправителяТранспортноеСредствоПриИзменении(Элемент)
	...
	ЗначениеРеквизита = ЭтотОбъект.ХранимыеДанныеТитулГрузоотправителяТранспортноеСредство;
...
Процедура УстановитьТекущийШагПомощника(ПредыдущийТекущийТитул = Неопределено)
	...
	Иначе
		...
		Если ТитулСтраницы = ПредопределенноеЗначение("Перечисление.ТипыЭлементовРегламентаЭДО.ЭТрН_Титул2") Тогда
...
Процедура ОбработатьИзменениеШага(ИмяШага, НавигационнаяСсылка)
	...
	Если ИмяШага = "Шаг10" Или ИмяШага = "Шаг11" Или ИмяШага = "Шаг12" Или ИмяШага = "Шаг13" Тогда
		...
		Если ИмяШага = "Шаг10" Тогда
			ИнкрементироватьОтображаемуюВерсиюТитула("ДопТитулПереадресовка", ИнкриментВерсии);
			УстановитьВидимостьСтраницыНачалоДоп();
		ИначеЕсли ИмяШага = "Шаг11" И СтатусЗаменыДоп(ЭтотОбъект) > 0 Тогда
			ИнкрементироватьОтображаемуюВерсиюТитула("ДопТитулПеревозчикаЗамены", ИнкриментВерсии);
			УстановитьВидимостьСтраницыТитулКорректировкиЭстафетаДоп();
		ИначеЕсли ИмяШага = "Шаг" + Строка(9 + ВсегоШагов - 1) Тогда
			ИнкрементироватьОтображаемуюВерсиюТитула("ДопТитулГрузополучателя", ИнкриментВерсии);
			УстановитьВидимостьСтраницыТитулГрузополучателяДоп();
		ИначеЕсли ИмяШага = "Шаг" + Строка(9 + ВсегоШагов) Тогда
			ИнкрементироватьОтображаемуюВерсиюТитула("ДопТитулПеревозчикаВыдача", ИнкриментВерсии);
			УстановитьВидимостьСтраницыТитулПеревозчикаПриРазгрузкеДоп();
		КонецЕсли;
		УстановитьВидимостьСтраницыНачало(Ложь);
	Иначе 
		...
		Если ИмяШага = "Шаг1" Тогда
			ИнкрементироватьОтображаемуюВерсиюТитула("ТитулГрузоотправителя", ИнкриментВерсии);
			УстановитьВидимостьСтраницыНачало();
		ИначеЕсли ИмяШага = "Шаг2" Тогда
			ИнкрементироватьОтображаемуюВерсиюТитула("ТитулПеревозчикаПриемка", ИнкриментВерсии);
			УстановитьВидимостьСтраницыТитулПеревозчика();
		...
		// 	ИнкрементироватьОтображаемуюВерсиюТитула("ТитулУказаниеПереадрес", ИнкриментВерсии);
		// 	УстановитьВидимостьСтраницыТитулУказаниеПереадресовки();
		ИначеЕсли ИмяШага = "Шаг" + Строка(?(ПереадресовкаДоЗамены(ЭтотОбъект), 3, 4)) И СтатусПереадресовки(ЭтотОбъект) > 0 Тогда
			ИнкрементироватьОтображаемуюВерсиюТитула("ТитулПереадресовка", ИнкриментВерсии);
			УстановитьВидимостьСтраницыТитулПереадресовки();
		ИначеЕсли ИмяШага = "Шаг" + Строка(?(ПереадресовкаДоЗамены(ЭтотОбъект), 4, 3)) И СтатусЗамены(ЭтотОбъект) > 0 Тогда
			ИнкрементироватьОтображаемуюВерсиюТитула("ТитулПеревозчикаЗамены", ИнкриментВерсии);
			УстановитьВидимостьСтраницыТитулКорректировкиЭстафета();	
		ИначеЕсли ИмяШага = "Шаг" + Строка(ВсегоШагов - 1 - ?(СтатусКорректировкиСтоимости(ЭтотОбъект) > 0, 2, 0)) Тогда
			ИнкрементироватьОтображаемуюВерсиюТитула("ТитулГрузополучателя", ИнкриментВерсии);
			УстановитьВидимостьСтраницыТитулГрузополучателя();
		ИначеЕсли ИмяШага = "Шаг" + Строка(ВсегоШагов - ?(СтатусКорректировкиСтоимости(ЭтотОбъект) > 0, 2, 0)) Тогда
			ИнкрементироватьОтображаемуюВерсиюТитула("ТитулПеревозчикаВыдача", ИнкриментВерсии);
			УстановитьВидимостьСтраницыТитулПеревозчикаПриРазгрузке();
		ИначеЕсли ИмяШага = "Шаг" + Строка(ВсегоШагов - 1) И СтатусКорректировкиСтоимости(ЭтотОбъект) > 0 Тогда
			ИнкрементироватьОтображаемуюВерсиюТитула("ТитулПеревозчикаФХЖ", ИнкриментВерсии);
			УстановитьВидимостьСтраницыТитулПлатеж();
		ИначеЕсли ИмяШага = "Шаг" + Строка(ВсегоШагов) И СтатусКорректировкиСтоимости(ЭтотОбъект) = 2 Тогда
			ИнкрементироватьОтображаемуюВерсиюТитула("ТитулГрузоотправителяФХЖ", ИнкриментВерсии);
			УстановитьВидимостьСтраницыТитулПлательщик();
		КонецЕсли;
		УстановитьВидимостьСтраницыНачалоДоп(Ложь);
	КонецЕсли;
...
//&НаКлиенте
//Процедура ПолучитьГУИДОтОператора(ИдентификаторАбонента, ЭтоВторойТитул = Ложь)
//	
...
Процедура ЗаполнитьИдентификациюФайлаОбмена_ПослеПолученияУИД(Результат, ДополнительныеПараметры) Экспорт
	...
	Для Каждого СтрокаВерсии Из ВерсииТитулов Цикл
		Если СтрокаВерсии.Титул = Объект.ТекущийТитул И ПоследняяВерсия <= СтрокаВерсии.НомерВерсии Тогда
			ПоследняяВерсия = СтрокаВерсии.НомерВерсии;
			ВерсияЗафиксирована = СтрокаВерсии.ИдентификаторФайла <> "";	
		КонецЕсли;	
	КонецЦикла;
	
	Если ЗначениеЗаполнено(Объект.ТекущийТитул) = Ложь Тогда
		ТребуетсяЗаполнить = Ложь;
	ИначеЕсли Переформировать = Ложь Тогда
		Если  Объект.ТекущийТитул = ПредопределенноеЗначение("Перечисление.ТипыЭлементовРегламентаЭДО.ЭТрН_ОткГО")
			Или Объект.ТекущийТитул = ПредопределенноеЗначение("Перечисление.ТипыЭлементовРегламентаЭДО.ЭТрН_ОткТ3")
			Или Объект.ТекущийТитул = ПредопределенноеЗначение("Перечисление.ТипыЭлементовРегламентаЭДО.ЭТрН_ОткП") Тогда
				ТребуетсяЗаполнить = Ложь;
		Иначе
	...
	Если ТребуетсяЗаполнить = Истина Тогда
		...
		ИначеЕсли Объект.ТекущийТитул = ПредопределенноеЗначение("Перечисление.ТипыЭлементовРегламентаЭДО.ЭТрН_Титул4") Тогда
			...
			ОбменСГИСЭПДКлиентСервер.УстановитьЗначениеРеквизитаВСтруктуреФормы(
					...
					ПолучитьПодписьТитулаBase64(ПредопределенноеЗначение("Перечисление.ТипыЭлементовРегламентаЭДО.ЭТрН_Титул3"), Истина), , КонтейнерОтображаемойВерсии);
		...
		ИначеЕсли Объект.ТекущийТитул = ПредопределенноеЗначение("Перечисление.ТипыЭлементовРегламентаЭДО.ЭТрН_ДопТитул4") Тогда
			...
			ВариантПриемкиДоп = ОбменСГИСЭПДКлиентСервер.ПолучитьЗначениеРеквизитаИзСтруктурыФормы(ЭтотОбъект, 
			...
			ОбменСГИСЭПДКлиентСервер.УстановитьЗначениеРеквизитаВСтруктуреФормы(
					ЭтотОбъект, "ДопТитулПеревозчикаВыдачаИдентификаторФайлаГрузополучателя", Объект.ДопТитулПеревозчикаВыдачаИдентификаторФайла, , КонтейнерОтображаемойВерсии);
			ОбменСГИСЭПДКлиентСервер.УстановитьЗначениеРеквизитаВСтруктуреФормы(
					ЭтотОбъект, "ДопТитулПеревозчикаВыдачаДатаФормированияФайлаГрузополучателя", Объект.ДопТитулПеревозчикаВыдачаДатаФормированияФайла, , КонтейнерОтображаемойВерсии);
			ОбменСГИСЭПДКлиентСервер.УстановитьЗначениеРеквизитаВСтруктуреФормы(
					ЭтотОбъект, "ДопТитулПеревозчикаВыдачаВремяФормированияФайлаГрузополучателя", Объект.ДопТитулПеревозчикаВыдачаВремяФормированияФайла, , КонтейнерОтображаемойВерсии);
			ОбменСГИСЭПДКлиентСервер.УстановитьЗначениеРеквизитаВСтруктуреФормы(
		...
		ИначеЕсли Объект.ТекущийТитул = ПредопределенноеЗначение("Перечисление.ТипыЭлементовРегламентаЭДО.ЭТрН_Титул6") Тогда
			...
			ОбменСГИСЭПДКлиентСервер.УстановитьЗначениеРеквизитаВСтруктуреФормы(
				...
				ПолучитьПодписьТитулаBase64(ПредопределенноеЗначение("Перечисление.ТипыЭлементовРегламентаЭДО.ЭТрН_Титул5"), Истина), , КонтейнерОтображаемойВерсии);
		КонецЕсли;
		...
		ОбменСГИСЭПДКлиентСервер.УстановитьЗначениеРеквизитаВСтруктуреФормы(
				ЭтотОбъект, ИнформацияПоПрефиксамТитула.ВПрограмме + "ВерсияФормата", ОбменСГИСЭПДКлиентСервер.ВерсияФормата(), , КонтейнерОтображаемойВерсии);
		...
		Если ИнформацияПоПрефиксамТитула.ВПрограмме = "ТитулПереадресовка"
			...
			Если ЗначениеЗаполнено(ДанныеСертификатаУчетнойЗаписиЭДО.НомерДоверенности) Тогда
				...
				ОбменСГИСЭПДКлиентСервер.УстановитьЗначениеРеквизитаВСтруктуреФормы(
					ЭтотОбъект, ИнформацияПоПрефиксамТитула.ВПрограмме + "Подписанты__1__СистемаСоСведениямиОбАннулированииДоверенности", ДанныеСертификатаУчетнойЗаписиЭДО.СведенияОбИнформационнойСистеме, , КонтейнерОтображаемойВерсии);
			КонецЕсли;
		Иначе
			ОбменСГИСЭПДКлиентСервер.УстановитьЗначениеРеквизитаВСтруктуреФормы(
			...
			КонецЕсли;
					...
					ОбменСГИСЭПДКлиентСервер.УстановитьЗначениеРеквизитаВСтруктуреФормы(
						ЭтотОбъект, ИнформацияПоПрефиксамТитула.ВПрограмме + "ПодписантКодСтатуса", СпособПодтверждения, , КонтейнерОтображаемойВерсии);
			ОбменСГИСЭПДКлиентСервер.УстановитьЗначениеРеквизитаВСтруктуреФормы(
				ЭтотОбъект, ИнформацияПоПрефиксамТитула.ВПрограмме + "ПодписантСпособПодтвержденияПолномочий", СпособПодтверждения, , КонтейнерОтображаемойВерсии);
			ОбменСГИСЭПДКлиентСервер.УстановитьЗначениеРеквизитаВСтруктуреФормы(
			...
			ОбменСГИСЭПДКлиентСервер.УстановитьЗначениеРеквизитаВСтруктуреФормы(
				...
				Если ЗначениеЗаполнено(ДанныеСертификатаУчетнойЗаписиЭДО.НомерДоверенности) Тогда
					...
					ОбменСГИСЭПДКлиентСервер.УстановитьЗначениеРеквизитаВСтруктуреФормы(
						ЭтотОбъект, ИнформацияПоПрефиксамТитула.ВПрограмме + "ПодписантСистемаСоСведениямиОбАннулированииДоверенности", ДанныеСертификатаУчетнойЗаписиЭДО.СведенияОбИнформационнойСистеме, , КонтейнерОтображаемойВерсии);
				КонецЕсли;
			Если ЗначениеЗаполнено(ДанныеСертификатаУчетнойЗаписиЭДО.НомерДоверенности) Тогда
				ОбменСГИСЭПДКлиентСервер.УстановитьЗначениеРеквизитаВСтруктуреФормы(
