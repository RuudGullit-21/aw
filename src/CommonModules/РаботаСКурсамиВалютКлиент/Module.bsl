...
Процедура ОповеститьКурсыУстарели() Экспорт
	...
	ПоказатьОповещениеПользователя(
		НСтр("ru = 'Курсы валют устарели'; en = 'Exchange rates are outdated'"),
		НавигационнаяСсылкаОбработки(),
		НСтр("ru = 'Обновить курсы валют'; en = 'Update exchange rates'"),
...
Процедура ОповеститьКурсыУспешноОбновлены() Экспорт
	...
	ПоказатьОповещениеПользователя(
		НСтр("ru = 'Курсы валют успешно обновлены'; en = 'Exchange rates are successfully updated'"),
		,
		НСтр("ru = 'Курсы валют обновлены'; en = 'Exchange rates are updated'"),
...
Процедура ОповеститьКурсыАктуальны() Экспорт
	...
	ПоказатьПредупреждение(,НСтр("ru = 'Курсы валют актуальны.'; en = 'Exchange rates are relevant.'"));
