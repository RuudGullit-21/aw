...
Функция ОписанияДатЗапрета() Экспорт
	...
	Список.Вставить("",                      НСтр("ru = 'Не установлена'; en = 'Not installed'"));
	Список.Вставить("ПроизвольнаяДата",      НСтр("ru = 'Произвольная дата'; en = 'Custom date'"));
	Список.Вставить("КонецПрошлогоГода",     НСтр("ru = 'Конец прошлого года'; en = 'Last year end'"));
	Список.Вставить("КонецПрошлогоКвартала", НСтр("ru = 'Конец прошлого квартала'; en = 'Last quarter end'"));
	Список.Вставить("КонецПрошлогоМесяца",   НСтр("ru = 'Конец прошлого месяца'; en = 'Last month end'"));
	Список.Вставить("КонецПрошлойНедели",    НСтр("ru = 'Конец прошлой недели'; en = 'Last week end'"));
	Список.Вставить("ПредыдущийДень",        НСтр("ru = 'Предыдущий день'; en = 'Previous day'"));
...
"за период с %3 по %4, истекла %5.'; en = 'It is forbidden to enter and edit data for all past periods"
"by %1 inclusive (%2)."
"Delay that allowed input and editing of data"
"for the period from %3 to %4, expired %5.'"),
...
"  за все прошлые периоды по %5 (%3).'; en = '• By %1 inclusive is prohibited enter and edit data"
"  for all past periods by %2"
"  and valid deferral to allow enter and edit data"
"  or the period from %4 by %5;"
"• With %6 will start to operate a ban to enter and edit data"
"  for all past periods by %5 (%3).'"),
	...
	Иначе 
		...
		ТекстНадписи = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Запрещен ввод и редактирование данных за все прошлые периоды"
"по %1 (%2)'; en = 'Prohibited the entry and editing of data for all prior periods"
"for %1 (%2)'"),
			Формат(Контекст.ДатаЗапрета, "ДЛФ=Д"), НРег(ОписанияДатЗапрета()[Контекст.ОписаниеДатыЗапрета]));
	КонецЕсли;
