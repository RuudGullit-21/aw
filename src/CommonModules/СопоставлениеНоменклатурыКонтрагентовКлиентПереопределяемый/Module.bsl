...
//   * ОграничениеТипаНоменклатуры - ОписаниеТипов - позволяет ограничить типы справочников, используемые при
//      сопоставлении. Соответствует свойству ОграничениеТипаНоменклатуры параметра Настройки метода 
