...
Процедура ДобавитьКомандуПечатиСогласияНаОбработкуПерсональныхДанных(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("ru = 'Согласие на обработку ПДн...'; en = 'Consent to personal data processing ...'");
...
Процедура ПриЗаполненииСпискаТекущихДел(ТекущиеДела) Экспорт
	...
	Для Каждого Раздел Из Разделы Цикл
		...
		Дело.Представление  = НСтр("ru = 'Согласия на обработку ПДн'; en = 'Consents to personal data processing'");
...
Процедура ПриЗаполненииРазделовДатЗапретаИзменения(Разделы) Экспорт
	...
	Раздел.Представление = НСтр("ru = 'Обработка персональных данных'; en = 'Processing of personal data'");
...
Функция ОбластиПерсональныхДанных()
	...
	НоваяОбласть.Представление = НСтр("ru = 'Обработка ПДн'; en = 'Processing Of Personal Data'");
...
Функция ДеревоОбластейПерсональныхДанных()
	...
	Если ОбластиДанных.Количество() = 0 
		...
		ДобавитьОбластьДанныхВДерево(ДеревоОбластейДанных, ОбластиДанных, Новый Структура("Имя, Представление, Родитель", "", НСтр("ru = 'Персональные данные'; en = 'Personal information'")));
	КонецЕсли;
