...
Функция ЧастиИмени(ФамилияИмяОтчество) Экспорт
	...
	Если ЧастиИмени.Количество() > 3 Тогда
		...
		ДополнительныеЧастиОтчества.Добавить(НСтр("ru = 'оглы'; en = 'ogly'"));
		ДополнительныеЧастиОтчества.Добавить(НСтр("ru = 'улы'; en = 'uly'"));
		ДополнительныеЧастиОтчества.Добавить(НСтр("ru = 'уулу'; en = 'uulu'"));
		ДополнительныеЧастиОтчества.Добавить(НСтр("ru = 'кызы'; en = 'qizy'"));
		ДополнительныеЧастиОтчества.Добавить(НСтр("ru = 'гызы'; en = 'gizi'"));
