...
Функция СтандартныеИнтервалыОповещения()
	...
	Результат.Добавить(НСтр("ru = '5 минут'; en = '5 minutes'"));
	Результат.Добавить(НСтр("ru = '10 минут'; en = '10 minutes'"));
	Результат.Добавить(НСтр("ru = '15 минут'; en = '15 minutes'"));
	Результат.Добавить(НСтр("ru = '30 минут'; en = '30 minutes'"));
	Результат.Добавить(НСтр("ru = '1 час'; en = '1 hour'"));
	Результат.Добавить(НСтр("ru = '2 часа'; en = '2 hours'"));
	Результат.Добавить(НСтр("ru = '4 часа'; en = '4 hours'"));
	Результат.Добавить(НСтр("ru = '8 часов'; en = '8 hours'"));
	Результат.Добавить(НСтр("ru = '1 день'; en = '1 day'"));
	Результат.Добавить(НСтр("ru = '2 дня'; en = '2 days'"));
	Результат.Добавить(НСтр("ru = '3 дня'; en = '3 days'"));
	Результат.Добавить(НСтр("ru = '1 неделю'; en = '1 week'"));
	Результат.Добавить(НСтр("ru = '2 недели'; en = '2 weeks'"));
...
Функция ПолучитьСтандартныеРасписанияДляНапоминания()
	...
	Результат.Вставить(НСтр("ru = 'по понедельникам, в 9:00'; en = 'on Mondays at 9 a.m.'"), Расписание);
	...
	Расписание.ДниНедели = ДниНедели;
	Результат.Вставить(НСтр("ru = 'по пятницам, в 15:00'; en = 'on Fridays at 3 p.m.'"), Расписание);
	...
	Для Каждого Напоминание Из СписокНапоминаний Цикл
		...
		Если ПодошедшееВремяСобытия.Количество() > 0
			...
			Или ГрафикСобытияНаГод.Количество() = 12 И ТекущаяДатаСеанса() > Напоминание.ВремяСобытия + 60*60*24*7 Тогда
				...
				Исключение
					ОтменитьТранзакцию();
					ЗаписьЖурналаРегистрации(НСтр("ru = 'Напоминания пользователя'; en = 'User reminders'", ОбщегоНазначения.КодОсновногоЯзыка()),
