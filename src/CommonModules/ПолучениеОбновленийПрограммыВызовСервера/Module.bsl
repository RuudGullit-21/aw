...
"<br />Используемая сейчас версия: %3'; en = 'To use the program %1, use the version of the platform &quot;1C:Enterprise 8&quot; not lower than: <b>%2</b>"
"<br /> Current version: %3'"),
		?(ПараметрыБазовойФункциональности.РаботаВПрограммеЗапрещена,
			НСтр("ru = 'необходимо'; en = 'required'"),
			НСтр("ru = 'рекомендуется'; en = 'recommended'")),
...
"Необходимо обратиться к администратору для обновления версии платформы 1С:Предприятие.'; en = 'Entrance into the program is impossible.<br />"
"It is necessary to contact the administrator to update the version of 1C:Enterprise platform.'");
		
	ИначеЕсли ПараметрыБазовойФункциональности.РаботаВПрограммеЗапрещена Тогда
		
		ТекстСообщения = ТекстСообщения + "<br /><br />"
			+ НСтр("ru = 'Вход в программу невозможен.<br />"
"Необходимо предварительно обновить версию платформы 1С:Предприятие.'; en = 'Entrance into the program is impossible.<br />"
"It is necessarry first to update the version of 1C:Enterprise platform.'");
