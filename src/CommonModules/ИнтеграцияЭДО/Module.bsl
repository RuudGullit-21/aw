...
Процедура УПД2019_ИнформацияПродавца_АвтозаполнениеОбстоятельствФормированияСФПоВидуОборота(Данные)
	...
	ПереченьОбстоятельствФормированияСФ = "01,02,03,04,05,06,07,08";

	Если СтрНайти(ПереченьОбстоятельствФормированияСФ, ВидОборота) Тогда 
...
//  Если форматом не предполагается указание документов-оснований, то возвращает пустрые строки.
// 
// Параметры:
//  Формат - Строка - одно из значений поддерживаемого формата см. ЭлектронныеДокументыЭДО.ПоддерживаемыеФорматы
// 
