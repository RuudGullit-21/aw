...
// Процедура - Перед периодической отправкой данных клиента на сервер 
//
...
//
// Параметры:
//  Параметры	 - Соответствие - Имя (строка) и значение (Произвольный) параметра, передаваемого на сервер
//
Процедура ПередПериодическойОтправкойДанныхКлиентаНаСервер(Параметры) Экспорт
	
КонецПроцедуры

// Процедура - После периодического получения данных клиента на сервере 
//
...
//
// Параметры:
//  Результаты	 - Соответствие - Имя (строка) и значение (произвольный) параметров,
