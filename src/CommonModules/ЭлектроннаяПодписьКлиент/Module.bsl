...
Процедура Расшифровать(ОписаниеДанных, Форма = Неопределено, ОбработкаРезультата = Неопределено) Экспорт
	...
	СерверныеПараметры = Новый Структура;
	СерверныеПараметры.Вставить("Операция",            НСтр("ru = 'Расшифровка данных'; en = 'Decryption of data'"));
	СерверныеПараметры.Вставить("ЗаголовокДанных",     НСтр("ru = 'Данные'; en = 'Data'"));
	СерверныеПараметры.Вставить("ОтборСертификатов");
...
Процедура ИнформироватьОПодписанииОбъекта(ПредставлениеДанных, МножествоДанных = Ложь, ИзФайла = Ложь) Экспорт
	...
	Если ИзФайла Тогда
		Если МножествоДанных Тогда
			ТекстСообщения = НСтр("ru = 'Добавлены подписи из файлов:'; en = 'Signatures from files added:'");
		Иначе
			ТекстСообщения = НСтр("ru = 'Добавлена подпись из файла:'; en = 'Signature from file is added:'");
		КонецЕсли;
	Иначе
		Если МножествоДанных Тогда
			ТекстСообщения = НСтр("ru = 'Установлены подписи:'; en = 'Digitally signed:'");
		Иначе
			ТекстСообщения = НСтр("ru = 'Установлена подпись:'; en = 'Digitally signed:'");
		КонецЕсли;
	КонецЕсли;
...
Процедура ИнформироватьОШифрованииОбъекта(ПредставлениеДанных, МножествоДанных = Ложь) Экспорт
	...
	ТекстСообщения = НСтр("ru = 'Выполнено шифрование:'; en = 'Encrypted:'");
...
Процедура ИнформироватьОРасшифровкеОбъекта(ПредставлениеДанных, МножествоДанных = Ложь) Экспорт
	...
	ТекстСообщения = НСтр("ru = 'Выполнена расшифровка:'; en = 'Decrypted:'");
