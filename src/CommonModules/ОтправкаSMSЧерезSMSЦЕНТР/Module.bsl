...
"%1 (код ошибки: %2)'; en = 'Unable to send SMS:"
...
Функция ОписаниеОшибкиОтправки(КодОшибки)
	...
	ОписанияОшибок.Вставить(1, НСтр("ru = 'Ошибка в параметрах.'; en = 'Error in parameters.'"));
	ОписанияОшибок.Вставить(2, НСтр("ru = 'Неверный логин или пароль.'; en = 'Incorrect username or password.'"));
	ОписанияОшибок.Вставить(3, НСтр("ru = 'Недостаточно средств на счете.'; en = 'Insufficient fundsat account.'"));
	ОписанияОшибок.Вставить(4, НСтр("ru = 'IP-адрес временно заблокирован из-за частых ошибок в запросах. Подробнее см. http://smsc.ru/faq/99'; en = 'IP address is temporarily blocked due to frequent errors in queries. See more http://smsc.ru/faq/99'"));
	ОписанияОшибок.Вставить(5, НСтр("ru = 'Неверный формат даты.'; en = 'Wrong date format.'"));
	ОписанияОшибок.Вставить(6, НСтр("ru = 'Сообщение запрещено (по тексту или по имени отправителя).'; en = 'Denied message (by text or by sender name).'"));
	ОписанияОшибок.Вставить(7, НСтр("ru = 'Неверный формат номера телефона.'; en = 'Incorrect phone number format.'"));
	ОписанияОшибок.Вставить(8, НСтр("ru = 'Сообщение на указанный номер не может быть доставлено.'; en = 'Message to specified number can not be delivered.'"));
	ОписанияОшибок.Вставить(9, НСтр("ru = 'Отправка более одного одинакового запроса на передачу SMS-сообщения в течение минуты.'; en = 'Sending more than one identical request for transmission of SMS messages within minutes.'"));
...
Функция ОписаниеОшибкиПолученияСтатуса(КодОшибки)
	...
	ОписанияОшибок.Вставить(1, НСтр("ru = 'Ошибка в параметрах.'; en = 'Error in parameters.'"));
	ОписанияОшибок.Вставить(2, НСтр("ru = 'Неверный логин или пароль.'; en = 'Incorrect username or password.'"));
	ОписанияОшибок.Вставить(5, НСтр("ru = 'Ошибка удаления сообщения.'; en = 'Deleting messages error.'"));
	ОписанияОшибок.Вставить(4, НСтр("ru = 'IP-адрес временно заблокирован из-за частых ошибок в запросах. Подробнее см. http://smsc.ru/faq/99'; en = 'IP address is temporarily blocked due to frequent errors in queries. See more http://smsc.ru/faq/99'"));
	ОписанияОшибок.Вставить(9, НСтр("ru = 'Отправка более пяти запросов на получения статуса одного и того же сообщения в течение минуты.'; en = 'Sending more than five requests to receive the status of the same message within a minute.'"));
...
Функция Разрешения() Экспорт
	...
	Адрес = "smsc.ru";
	Порт = Неопределено;
	Описание = НСтр("ru = 'Отправка SMS через ""SMS-ЦЕНТР"".'; en = 'Sending SMS using ""SMS CENTER"".'");
