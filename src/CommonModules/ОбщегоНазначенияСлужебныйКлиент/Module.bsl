...
#Если ВебКлиент Тогда
	Результат = НСтр("ru = 'Веб-клиент'; en = 'Web client'") + СистемнаяИнформация.ИнформацияПрограммыПросмотра;
...
#ИначеЕсли ТонкийКлиент Тогда
	Результат = НСтр("ru = 'Тонкий клиент'; en = 'Thin client'");
#КонецЕсли
...
Процедура ЗарегистрироватьCOMСоединительПриПроверкеРегистрации(Результат, Контекст) Экспорт
	...
	Иначе 
		...
		ЖурналРегистрацииКлиент.ДобавитьСообщениеДляЖурналаРегистрации(
			НСтр("ru = 'Регистрация компоненты comcntr'; en = 'comcntr component registration'", ОбщегоНазначенияКлиент.КодОсновногоЯзыка()),
			"Ошибка",
			ТекстСообщения,,
			Истина);
