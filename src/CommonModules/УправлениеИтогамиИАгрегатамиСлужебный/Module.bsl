...
"в зависимости от того, есть ли в программе регистры с агрегатами.'; en = 'Enables or disables updating and rebuilding aggregates on a schedule,"
"depending on whether there are registers with aggregates in the program.'");
...
Процедура ПриЗаполненииСпискаТекущихДел(ТекущиеДела) Экспорт
	...
	Прототип.Представление = НСтр("ru = 'Оптимизировать программу'; en = 'Optimize application'");
	Прототип.Подсказка     = НСтр("ru = 'Ускорить проведение документов и формирование отчетов."
"Обязательная ежемесячная процедура, может занять некоторое время.'; en = 'Speed up document posting and report generation."
