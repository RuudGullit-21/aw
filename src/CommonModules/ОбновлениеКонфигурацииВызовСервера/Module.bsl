...
Функция СформироватьТекстЗаставки(Знач ШаблонТекста)
	...
	ПараметрыТекста["[Шаг2ЗавершениеРаботы]"] = НСтр("ru = 'Завершение работы пользователей'; en = 'User work completion'");
	ПараметрыТекста["[Шаг3СозданиеРезервнойКопии]"] = НСтр("ru = 'Создание резервной копии информационной базы'; en = 'Создание резервной копии информационной базы'");
	...
	ПараметрыТекста["[Шаг9Завершение]"] = НСтр("ru = 'Завершение'; en = 'Closure'");
...
Функция СообщенияСкриптов()
	...
	Сообщения["[СообщениеЗавершениеРаботыПользователей]"] = НСтр("ru = 'Завершение работы пользователей'; en = 'User work completion'");
	Сообщения["[СообщениеСозданиеРезервнойКопииБазы]"] = НСтр("ru = 'Создание резервной копии информационной базы'; en = 'Создание резервной копии информационной базы'");
	...
	Сообщения["[СообщениеЗавершениеОбновления]"] = НСтр("ru = 'Завершение'; en = 'Closure'");
