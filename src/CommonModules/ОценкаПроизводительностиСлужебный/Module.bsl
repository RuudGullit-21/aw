...
Функция ОбщийМодуль(Имя) Экспорт
	...
	Иначе
		...
		Если ТипЗнч(Модуль) <> Тип("ОбщийМодуль") Тогда
			СообщениеИсключения = НСтр("ru = 'Общий модуль ""%1"" не найден.'; en = 'Common module ""%1"" was not found.'");
...
"либо для него не поддерживается получение модуля менеджера.'; en = 'Metadata object ""%1"" was not found or"
"receiving manager module is not supported for it.'");
		ВызватьИсключение СтрЗаменить(СообщениеИсключения, "%1", Имя);
	КонецЕсли;
