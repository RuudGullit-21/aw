...
Процедура ПоказатьПредупрежденияПриЗавершенииРаботы() Экспорт
	...
	Пояснение = НСтр("ru = 'и выполнить дополнительные действия'; en = 'and perform additional actions'");
	...
	КонецЕсли;
	ПоказатьОповещениеПользователя(НСтр("ru = 'Нажмите, чтобы завершить работу'; en = 'Click to complete work'"), 
