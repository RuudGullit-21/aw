...
Процедура ДобавитьСписокПолейНаФорму(Форма, Параметры) Экспорт
	...
	ПредставлениеПоля.Заголовок = НСтр("ru = 'Поле'; en = 'Field'");
...
Функция ПараметрыДобавленияСпискаПолей() Экспорт
	...
	Результат.Вставить("ПодсказкаВводаСтрокиПоиска", НСтр("ru = 'Найти...'; en = 'Find...'"));
...
Процедура ДобавитьГруппуОператоровРазделители(СписокОператоров)
	...
	Группа.Представление = НСтр("ru = 'Разделители'; en = 'Separators'");
	Группа.Порядок = 1;
	...
	ДобавитьОператорВГруппу(Группа, " ", НСтр("ru = 'Пробел'; en = 'Space'"), Новый ОписаниеТипов("Строка"));
...
Процедура ДобавитьГруппуОператоровЛогическиеОператорыИКонстанты(СписокОператоров)
	...
	Группа.Представление = НСтр("ru = 'Логические операторы и константы'; en = 'Logical operators and constants'");
	Группа.Порядок = 3;
	...
	ДобавитьОператорВГруппу(Группа, "И", НСтр("ru = 'И'; en = 'I'"), Тип);
	ДобавитьОператорВГруппу(Группа, "Или", НСтр("ru = 'Или'; en = 'OR'"), Тип);
	ДобавитьОператорВГруппу(Группа, "Не", НСтр("ru = 'Не'; en = 'Not'"), Тип);
	ДобавитьОператорВГруппу(Группа, "Истина", НСтр("ru = 'Истина'"), Тип);
	ДобавитьОператорВГруппу(Группа, "Ложь", НСтр("ru = 'Ложь'; en = 'Ложь'"), Тип);
...
Процедура ДобавитьГруппуОператоровЧисловыеФункции(СписокОператоров)
	...
	Группа.Представление = НСтр("ru = 'Числовые функции'; en = 'Numerical functions'");
	Группа.Порядок = 4;
	Группа.Картинка = БиблиотекаКартинок.ТипФункция;
	
	Тип = Новый ОписаниеТипов("Число");
	
	ДобавитьОператорВГруппу(Группа, "Макс", НСтр("ru = 'Максимум'; en = 'Max'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "Мин", НСтр("ru = 'Минимум'; en = 'Minimum'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "Окр", НСтр("ru = 'Округлить'; en = 'Округлить'"), Тип, Истина);
...
Процедура ДобавитьГруппуОператоровПрочиеФункции(СписокОператоров)
	...
	ДобавитьОператорВГруппу(Группа, "?", НСтр("ru = 'Условие'; en = 'Condition'"), Новый ОписаниеТипов("Булево"), Истина);
	...
	ДобавитьОператорВГруппу(Группа, "Формат", НСтр("ru = 'Формат'; en = 'Format'"), Новый ОписаниеТипов("Строка"), Истина);
...
Процедура ДобавитьГруппуОператоровОперацииСравнения(СписокОператоров)
	...
	ДобавитьОператорВГруппу(Группа, "В", НСтр("ru = 'В'; en = 'V'"), Тип, Истина);
