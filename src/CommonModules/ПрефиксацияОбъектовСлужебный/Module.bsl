...
Процедура ИзменитьПрефиксИБ(Параметры, АдресРезультата = "") Экспорт
	...
	Исключение
		...
		ВызватьИсключение НСтр("ru = 'Не удалось изменить префикс.'; en = 'Failed to change the prefix.'");
			...
			Если Характеристики.ДлинаКода = 0 И Характеристики.ДлинаНомера = 0 Тогда
				...
				Если Не РежимДиагностики Тогда
					...
					ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
						НСтр("ru = 'Ошибка внедрения подсистемы ""%1"" для объекта метаданных ""%2"".'; en = 'Error implementation of subsystem ""%1"" for metadata object ""%2"".'"),
...
Функция СобытиеЖурналаРегистрацииПерепрефиксацияОбъектов()
	...
	Возврат НСтр("ru = 'Префиксация объектов.Изменение префикса информационной базы'; en = 'Object prefixation.Infobase prefix change'",
