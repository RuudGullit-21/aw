...
Функция СообщенияОбОшибках() Экспорт
	...
	СообщенияОбОшибках.Вставить(8,  НСтр("ru = 'Некорректно указано имя файла для выгрузки данных'; en = 'Incorrectly  specify file name for uploading data'"));
...
"Объект этой информационной базы был заменен версией объекта из второй информационной базы.'; en = 'An object change collision occurred."
...
"Объект из второй информационной базы не принят. Объект этой информационной базы не изменен.'; en = 'An object change collision occurred."
"The object from the second infobase is not accepted. The object from this infobase is not changed.'"));
	...
	СообщенияОбОшибках.Вставить(177, НСтр("ru = 'Имя плана обмена из сообщения обмена не соответствует ожидаемому.'; en = 'Exchange plan name from the exchange message is not as expected.'"));
	СообщенияОбОшибках.Вставить(178, НСтр("ru = 'Получатель из сообщения обмена не соответствует ожидаемому.'; en = 'Recipient from the exchange message is not as expected.'"));
...
Функция ПланОбменаАвтономнойРаботы() Экспорт
	...
	Если Результат.Количество() = 0 Тогда
		...
		ВызватьИсключение НСтр("ru = 'Автономная работа в системе не предусмотрена.'; en = 'Offline work in the application is not supported.'");
		
	ИначеЕсли Результат.Количество() > 1 Тогда
		
		ВызватьИсключение НСтр("ru = 'Создано более одного плана обмена для автономной работы.'; en = 'More than one exchange plan for offline work was created.'");
...
"""%1"".'; en = 'No temporary file directory."
"Make sure the value of parameter"
"""%1"" was correctly set in the application settings.'", ОбщегоНазначения.КодОсновногоЯзыка());
