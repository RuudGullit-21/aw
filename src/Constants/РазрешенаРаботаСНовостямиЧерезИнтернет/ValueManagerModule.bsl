...
"Новое значение: %НовоеЗначение%'; en = 'Constant РазрешенаРаботаСНовостямиЧерезИнтернет is saved"
...
"New value: %НовоеЗначение%'");
		...
		ОбработкаНовостейВызовСервера.ЗаписатьСообщениеВЖурналРегистрации(
			...
			НСтр("ru = 'Новости. Изменение данных. Константы. РазрешенаРаботаСНовостямиЧерезИнтернет'; en = 'News. change data. Constants. РазрешенаРаботаСНовостямиЧерезИнтернет'", ОбщегоНазначения.КодОсновногоЯзыка()), // ИдентификаторШага.
