...
""
"Новое значение:"
"%НовоеЗначение%'; en = 'Constant НастройкиНовостей is saved"
"Previous value:"
"%ПредыдущееЗначение%"
""
"New value:"
"%НовоеЗначение%'");
		...
		ОбработкаНовостейВызовСервера.ЗаписатьСообщениеВЖурналРегистрации(
			...
			НСтр("ru = 'Новости. Изменение данных. Константы. НастройкиНовостей'; en = 'News. Change data. Constants. SettingNews'", ОбщегоНазначения.КодОсновногоЯзыка()), // ИдентификаторШага.
