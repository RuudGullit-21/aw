...
Процедура ПослеЗагрузкиНастроекВКомпоновщик(ДополнительныеПараметры) Экспорт
	...
	Если Вариант = "ПраваРолей" Тогда
		ВариантНаименование = НСтр("ru = 'Права ролей'; en = 'Role rights'");
...
Процедура ЗавершитьВывод(ДокументРезультат, ДанныеРасшифровки, Вариант, ПрофилиВместоРолей, ВысотаШапки)
	...
	ИначеЕсли Вариант = "ПодробныеПраваРолиНаОбъектМетаданных" Тогда
		ПервыйЗаголовокТаблицы = ?(ПрофилиВместоРолей, НСтр("ru = 'Профиль'; en = 'Profile'"), НСтр("ru = 'Роль'; en = 'Role'"));
	Иначе
		ПервыйЗаголовокТаблицы = НСтр("ru = 'Роль'; en = 'Role'");
	КонецЕсли;
...
Процедура НастроитьПараметрУровеньДоступа(Настройки)
	...
	Список.Добавить(02, НСтр("ru = 'Использование'; en = 'Use'"));
	Список.Добавить(03, НСтр("ru = 'Чтение'; en = 'Read'"));
	Список.Добавить(04, НСтр("ru = 'Просмотр'; en = 'View'"));
	Список.Добавить(05, НСтр("ru = 'Изменение'; en = 'Change'"));
	Список.Добавить(06, НСтр("ru = 'Редактирование'; en = 'Edit'"));
	Список.Добавить(07, НСтр("ru = 'Добавление'; en = 'Create'"));
	Список.Добавить(08, НСтр("ru = 'Интерактивное добавление'; en = 'Interactive insert'"));
...
Функция ДеревоМетаданных(СПолями)
	...
	СтрокаКонфигурация.Представление        = НСтр("ru = 'Конфигурация'; en = 'Configuration'");
	СтрокаКонфигурация.ПредставлениеОбъекта = НСтр("ru = 'Конфигурация'; en = 'Configuration'");
	
	// Конфигурация.Общие
	СтрокаОбщие = СтрокаКонфигурация.Строки.Добавить();
	СтрокаОбщие.Имя           = "Общие";
	СтрокаОбщие.Представление = НСтр("ru = 'Общие'; en = 'General'");
	...
	СтрокаПодсистемы.Представление        = НСтр("ru = 'Подсистемы'; en = 'Subsystems'");
	СтрокаПодсистемы.ПредставлениеОбъекта = НСтр("ru = 'Подсистема'; en = 'Subsystem'");
	...
	СтрокаВложенныеПодсистемы.Представление        = НСтр("ru = 'Подсистемы'; en = 'Subsystems'");
	СтрокаВложенныеПодсистемы.ПредставлениеОбъекта = НСтр("ru = 'Подсистема'; en = 'Subsystem'");
	...
	СтрокаПараметрыСеанса.Представление        = НСтр("ru = 'Параметры сеанса'; en = 'Session parameters'");
	...
	СтрокаОбщиеРеквизиты.Представление        = НСтр("ru = 'Общие реквизиты'; en = 'Common attributes'");
	СтрокаОбщиеРеквизиты.ПредставлениеОбъекта = НСтр("ru = 'Общий реквизит'; en = 'Common attribute'");
	...
	СтрокаПланыОбмена.Представление        = НСтр("ru = 'Планы обмена'; en = 'Exchange plans'");
	СтрокаПланыОбмена.ПредставлениеОбъекта = НСтр("ru = 'План обмена'; en = 'Exchange plan'");
	...
	СтрокаКритерииОтбора.Представление        = НСтр("ru = 'Критерии отбора'; en = 'Filter criteria'");
	СтрокаКритерииОтбора.ПредставлениеОбъекта = НСтр("ru = 'Критерий отбора'; en = 'Filter criterion'");
	...
	СтрокаОбщиеФормы.Представление        = НСтр("ru = 'Общие формы'; en = 'Common forms'");
	...
	СтрокаОбщиеКоманды.Представление        = НСтр("ru = 'Общие команды'; en = 'Common commands'");
	...
	СтрокаWebСервисы.Представление        = НСтр("ru = 'Web-сервисы'; en = 'Web services'");
	...
	СтрокаКонстанты.Представление        = НСтр("ru = 'Константы'; en = 'Constants'");
	СтрокаКонстанты.ПредставлениеОбъекта = НСтр("ru = 'Константа'; en = 'Constant'");
	...
	СтрокаСправочники.Представление        = НСтр("ru = 'Справочники'; en = 'Catalogs'");
	СтрокаСправочники.ПредставлениеОбъекта = НСтр("ru = 'Справочник'; en = 'Catalog'");
	...
	СтрокаГруппаДокументы.Представление = НСтр("ru = 'Документы'; en = 'Documents'");
	...
	СтрокаПоследовательности.Представление        = НСтр("ru = 'Последовательности'; en = 'Sequences'");
	...
	СтрокаДокументы.ПредставлениеОбъекта = НСтр("ru = 'Документ'; en = 'Document'");
	...
	СтрокаЖурналыДокументов.Представление        = НСтр("ru = 'Журналы документов'; en = 'Document journals'");
	СтрокаЖурналыДокументов.ПредставлениеОбъекта = НСтр("ru = 'Журнал документов'; en = 'Document journal'");
	...
	СтрокаПеречисления.Представление        = НСтр("ru = 'Перечисления'; en = 'Transfers'");
	СтрокаПеречисления.ПредставлениеОбъекта = НСтр("ru = 'Перечисление'; en = 'Enum'");
	...
	СтрокаОтчеты.ПредставлениеОбъекта = НСтр("ru = 'Отчет'; en = 'Report'");
	...
	СтрокаОбработки.Представление        = НСтр("ru = 'Обработки'; en = 'Data processors'");
	СтрокаОбработки.ПредставлениеОбъекта = НСтр("ru = 'Обработка'; en = 'Processing'");
	...
	СтрокаПланыВидовХарактеристик.Представление        = НСтр("ru = 'Планы видов характеристик'; en = 'Charts of characteristic types'");
	СтрокаПланыВидовХарактеристик.ПредставлениеОбъекта = НСтр("ru = 'План видов характеристик'; en = 'Chart of characteristic types'");
	...
	СтрокаПланыСчетов.Представление        = НСтр("ru = 'Планы счетов'; en = 'Charts of accounts'");
	СтрокаПланыСчетов.ПредставлениеОбъекта = НСтр("ru = 'План счетов'; en = 'Chart of accounts'");
	...
	СтрокаПланыВидовРасчета.Представление        = НСтр("ru = 'Планы видов расчета'; en = 'Charts of calculation types'");
	СтрокаПланыВидовРасчета.ПредставлениеОбъекта = НСтр("ru = 'План видов расчета'; en = 'Chart of calculation types'");
	...
	СтрокаРегистрыСведений.Представление        = НСтр("ru = 'Регистры сведений'; en = 'Information registers'");
	СтрокаРегистрыСведений.ПредставлениеОбъекта = НСтр("ru = 'Регистр сведений'; en = 'Information register'");
	...
	СтрокаРегистрыНакопления.Представление        = НСтр("ru = 'Регистры накопления'; en = 'Accumulation registers'");
	СтрокаРегистрыНакопления.ПредставлениеОбъекта = НСтр("ru = 'Регистр накопления'; en = 'Accumulation register'");
	...
	СтрокаРегистрыБухгалтерии.Представление        = НСтр("ru = 'Регистры бухгалтерии'; en = 'Accounting registers'");
	СтрокаРегистрыБухгалтерии.ПредставлениеОбъекта = НСтр("ru = 'Регистр бухгалтерии'; en = 'Accounting register'");
	...
	СтрокаРегистрыРасчета.Представление        = НСтр("ru = 'Регистры расчета'; en = 'Calculation registers'");
	СтрокаРегистрыРасчета.ПредставлениеОбъекта = НСтр("ru = 'Регистр расчета'; en = 'Calculation register'");
	...
	СтрокаБизнесПроцессы.Представление        = НСтр("ru = 'Бизнес процессы'; en = 'Business processes'");
	СтрокаБизнесПроцессы.ПредставлениеОбъекта = НСтр("ru = 'Бизнес процесс'; en = 'Business process'");
	...
	СтрокаЗадачи.Представление        = НСтр("ru = 'Задачи'; en = 'Tasks'");
	СтрокаЗадачи.ПредставлениеОбъекта = НСтр("ru = 'Задача'; en = 'Task'");
	...
	СтрокаВнешниеИсточникиДанных.Представление        = НСтр("ru = 'Внешние источники данных'; en = 'External data sources'");
	...
	СтрокаТаблицы.Представление        = НСтр("ru = 'Таблицы'; en = 'Tables'");
	СтрокаТаблицы.ПредставлениеОбъекта = НСтр("ru = 'Таблица'; en = 'Table'");
	...
	СтрокаФункции.Представление        = НСтр("ru = 'Функции'; en = 'Function'");
...
Процедура ДобавитьКомандыИПоля(СПолями, СтрокаДерева, Поля = "Реквизиты, ТабличныеЧасти, СтандартныеРеквизиты", БезРедактирования = Ложь)
	...
	Если СПолями И СтруктураПолей.Свойство("Измерения") Тогда
		...
		СтрокаИзмерения.Представление        = НСтр("ru = 'Измерения'; en = 'Dimensions'");
		СтрокаИзмерения.ПредставлениеОбъекта = НСтр("ru = 'Измерение'; en = 'Измерение'");
	КонецЕсли;
	...
	Если СПолями И СтруктураПолей.Свойство("Ресурсы") Тогда
		...
		СтрокаРесурсы.Представление        = НСтр("ru = 'Ресурсы'; en = 'Resources'");
	...
	Если СПолями И СтруктураПолей.Свойство("Реквизиты") Тогда
		...
		СтрокаРеквизиты.Представление        = НСтр("ru = 'Реквизиты'; en = 'Attributes'");
		СтрокаРеквизиты.ПредставлениеОбъекта = НСтр("ru = 'Реквизит'; en = 'Property'");
	КонецЕсли;
	...
	Если СПолями И СтруктураПолей.Свойство("Поля") Тогда
		...
		СтрокаПоля.Представление        = НСтр("ru = 'Поля'; en = 'Fields'");
		СтрокаПоля.ПредставлениеОбъекта = НСтр("ru = 'Поле'; en = 'Field'");
	КонецЕсли;
	...
	Если СПолями И СтруктураПолей.Свойство("ПризнакиУчета") Тогда
		...
		СтрокаПризнакиУчета.Представление        = НСтр("ru = 'Признаки учета'; en = 'Accounting flags'");
	...
	Если СПолями И СтруктураПолей.Свойство("ТабличныеЧасти") Тогда
		...
		СтрокаТабличныеЧасти.Представление        = НСтр("ru = 'Табличные части'; en = 'Tabular sections'");
		СтрокаТабличныеЧасти.ПредставлениеОбъекта = НСтр("ru = 'Табличная часть'; en = 'Tabular section'");
		...
		СтрокаТабличныеЧастиРеквизиты.Представление        = НСтр("ru = 'Реквизиты'; en = 'Attributes'");
		СтрокаТабличныеЧастиРеквизиты.ПредставлениеОбъекта = НСтр("ru = 'Реквизит'; en = 'Property'");
	...
	Если СПолями И СтруктураПолей.Свойство("СтандартныеРеквизиты") Тогда
		...
		СтрокаСтандартныеРеквизиты.Представление        = НСтр("ru = 'Стандартные реквизиты'; en = 'Standard attributes'");
	...
	Если СПолями И СтруктураПолей.Свойство("СтандартныеТабличныеЧасти") Тогда
		...
		СтрокаСтандартныеТабличныеЧастиСтандартныеРеквизиты.Представление        = НСтр("ru = 'Стандартные реквизиты'; en = 'Standard attributes'");
	...
	СтрокаКоманды.Представление        = НСтр("ru = 'Команды'; en = 'Commands'");
	СтрокаКоманды.ПредставлениеОбъекта = НСтр("ru = 'Команда'; en = 'Command'");
...
Функция ПраваКонфигурации()
	...
	СписокПрав.Добавить("ОбновлениеКонфигурацииБазыДанных",
		НСтр("ru = 'Обновление конфигурации базы данных'; en = 'Update infobase configuration'"));
	
	СписокПрав.Добавить("МонопольныйРежим",
		НСтр("ru = 'Монопольный режим'; en = 'Exclusive mode'"));
	...
	СписокПрав.Добавить("ЖурналРегистрации",
		НСтр("ru = 'Журнал регистрации'; en = 'Event log'"));
	
	СписокПрав.Добавить("ТонкийКлиент",
		НСтр("ru = 'Тонкий клиент'; en = 'Thin client'"));
	
	СписокПрав.Добавить("ВебКлиент",
		НСтр("ru = 'Веб-клиент'; en = 'Web client'"));
	...
	СписокПрав.Добавить("РежимВсеФункции",
		НСтр("ru = 'Режим ""Все функции""'; en = 'Mode ""All functions""'"));
	...
	СписокПрав.Добавить("СохранениеДанныхПользователя",
		НСтр("ru = 'Сохранение данных пользователя'; en = 'Save user data'"));
...
Функция ПраваРеквизита(БезРедактирования = Ложь)
	...
	Если Не БезРедактирования Тогда
		СписокПрав.Добавить("Редактирование",
			НСтр("ru = 'Редактирование'; en = 'Edit'"));
...
Функция ПраваРегистраСведений()
	...
	СписокПрав.Добавить("УправлениеИтогами",
		НСтр("ru = 'Управление итогами'; en = 'Totals management'"));
...
Процедура ДобавитьПраваПрограммнойРаботыСОбъектами(СписокПрав, БезИзменения = Ложь, Ссылочные = Истина, СОграничением = Истина)
	...
	СписокПрав.Добавить("Чтение",
		НСтр("ru = 'Чтение'; en = 'Read'"), СОграничением);
	...
	СписокПрав.Добавить("Изменение",
		НСтр("ru = 'Изменение'; en = 'Change'"), СОграничением);
	...
	СписокПрав.Добавить("Добавление",
		НСтр("ru = 'Добавление'; en = 'Create'"), СОграничением);
	
	СписокПрав.Добавить("Удаление",
		НСтр("ru = 'Удаление'; en = 'Delete'"), СОграничением);
...
Процедура ДобавитьПраваИнтерактивнойРаботыСОбъектами(СписокПрав, БезИзменения = Ложь, Ссылочные = Истина, СПометкойУдаления = Истина)
	...
	СписокПрав.Добавить("ИнтерактивноеДобавление",
		НСтр("ru = 'Интерактивное добавление'; en = 'Interactive insert'"));
