...
"включая настройки для входа (если указаны).'; en = 'Shows detailed information about all users,"
...
"включая настройки для входа (если указаны).'; en = 'Shows detailed information about users,"
"including login settings (if specified).'");
...
"включая настройки для входа (если указаны).'; en = 'Shows detailed information about external users,"
"including login settings (if specified).'");
	НастройкиВарианта.ФункциональныеОпции.Добавить("ИспользоватьВнешнихПользователей");
КонецПроцедуры
