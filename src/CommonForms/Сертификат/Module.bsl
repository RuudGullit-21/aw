...
Процедура ПроверитьЗавершение(Результат, Контекст) Экспорт
	...
	ИначеЕсли Результат <> Неопределено Тогда
		...
		ПараметрыПредупреждения.Вставить("ЗаголовокПредупреждения",
			НСтр("ru = 'Сертификат недействителен по причине:'; en = 'Certificate is invalid due to:'"));
...
Процедура ЗаполнитьСвойстваСубъекта(Сертификат)
	...
	ПредставленияСвойств["ОбщееИмя"] = НСтр("ru = 'Общее имя'; en = 'Common name'");
	ПредставленияСвойств["Страна"] = НСтр("ru = 'Страна'; en = 'Country'");
	ПредставленияСвойств["Регион"] = НСтр("ru = 'Регион'; en = 'Region'");
	ПредставленияСвойств["НаселенныйПункт"] = НСтр("ru = 'Населенный пункт'; en = 'Locality'");
	ПредставленияСвойств["Улица"] = НСтр("ru = 'Улица'; en = 'Street'");
	ПредставленияСвойств["Организация"] = НСтр("ru = 'Организация'");
	ПредставленияСвойств["Подразделение"] = НСтр("ru = 'Подразделение'");
	ПредставленияСвойств["ЭлектроннаяПочта"] = НСтр("ru = 'Электронная почта'; en = 'Email'");
...
Процедура ЗаполнитьВнутренниеПоляСертификата()
	...
	Если ГруппаВнутреннихПолей = "Общие" Тогда
		...
		ДобавитьСвойство(Сертификат, "ИспользоватьДляПодписи",    НСтр("ru = 'Использовать для подписи'; en = 'Use for signature'"));
