...
Процедура ВидДиаграммыНачалоВыбораЗадержка()
	...
	Меню.Добавить(Неопределено, НСтр("ru = 'Не выводить'"),, БиблиотекаКартинок.сфпПустая);
...
Процедура ЗаполнитьВариантыСравнения()
	...
	Если НастройкиОтчета.ИспользоватьПериодичность Тогда
		Элементы.ПолеСравнения.СписокВыбора.Добавить(Перечисления.сфпПериодичность.День, НСтр("ru = 'Дни'"));
		Элементы.ПолеСравнения.СписокВыбора.Добавить(Перечисления.сфпПериодичность.Неделя, НСтр("ru = 'Недели'"));
		Элементы.ПолеСравнения.СписокВыбора.Добавить(Перечисления.сфпПериодичность.Месяц, НСтр("ru = 'Месяцы'"));
		Элементы.ПолеСравнения.СписокВыбора.Добавить(Перечисления.сфпПериодичность.Квартал, НСтр("ru = 'Кварталы'"));
		Элементы.ПолеСравнения.СписокВыбора.Добавить(Перечисления.сфпПериодичность.Полугодие, НСтр("ru = 'Полугодия'"));
		Элементы.ПолеСравнения.СписокВыбора.Добавить(Перечисления.сфпПериодичность.Год, НСтр("ru = 'Годы'"));
	КонецЕсли;
...
Процедура ОпределитьЭлементыИРеквизитыФильтра(Стр, ЭлементОтбора = Неопределено, ДоступноеПоле, РучноеДобавление)
	...
	ИначеЕсли ТипЗначения.СодержитТип(Тип("Булево")) Тогда
		...
		Значения.Добавить(Перечисления.сфпБулевоТриСостояния.НеИзменять, НСтр("ru = 'Все'"), Значение=Неопределено);
