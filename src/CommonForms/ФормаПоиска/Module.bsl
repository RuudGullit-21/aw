...
Процедура ПриВыполненииПоиска(Знач НаправлениеПоиска)
	...
	Если ПустаяСтрока(СтрокаПоиска) Тогда
		ПоказатьПредупреждение(, НСтр("ru = 'Введите, что нужно найти.'; en = 'Enter a search object.'"));
		Возврат;
	КонецЕсли;
...
Процедура ОбновитьПредставлениеОбластиПоиска()
	...
	Если Не ИскатьВРазделах Или Не УказаныОбластиПоиска Тогда
		ОбластиПоискаПредставление = НСтр("ru = 'Везде'; en = 'Everywhere'");
		Возврат;
	КонецЕсли;
	...
	Иначе	
		ОбластиПоискаПредставление = НСтр("ru = 'В выбранных разделах'; en = 'In selected sections'");
	КонецЕсли;
