...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначения.РазделениеВключено() Тогда
		ВызватьИсключение НСтр("ru = 'Использование Интернет-поддержки недоступно при работе в модели сервиса.'; en = 'Online support cannot be used in SaaS.'");
	КонецЕсли;
...
"Для подключения указывается логин %1.'; en = 'Cannot enable Online user support."
...
"%1'; en = 'Login and password are saved to the application,"
