...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначения.ЭтоМобильныйКлиент() Тогда
		...
		Элементы.ОчиститьРабочийКаталог.Заголовок = НСтр("ru = 'Очистить'; en = 'Clear'");
...
Процедура ОчиститьЛокальныйКэшФайловЗавершение(Результат, ПараметрыВыполнения) Экспорт
	...
	ПоказатьОповещениеПользователя(НСтр("ru = 'Рабочий каталог'; en = 'Working directory'"),, НСтр("ru = 'Очистка рабочего каталога успешно завершена.'"));
