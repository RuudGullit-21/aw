...
Процедура ИсключитьИзГруппы(Команда)
	...
	Если НЕ ЗначениеЗаполнено(ТекущаяГруппаДоступа) Тогда
		ПоказатьПредупреждение(, НСтр("ru = 'Группа доступа не выбрана.'; en = 'Access group is not selected.'"));
		Возврат;
	КонецЕсли;
...
"Редактировать группу доступа могут ответственный за участников группы доступа и администратор.'; en = 'Insufficient rights to edit access groups."
...
"так как он включен в нее косвенно.'; en = 'Cannot exclude user from the access group"
