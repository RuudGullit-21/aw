...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.ПринятиеРешенияОБлокировке Тогда
		...
		Если РазделениеВключено Тогда
			Элементы.ИнформационнаяБазаПеремещена.Заголовок = НСтр("ru = 'Приложение перемещено'; en = 'Application is moved'");
			Элементы.ЭтоКопияИнформационнойБазы.Заголовок = НСтр("ru = 'Это копия приложения'; en = 'This is an application copy'");
			Заголовок = НСтр("ru = 'Приложение было перемещено или восстановлено из резервной копии'; en = 'The application was transferred or restored from the backup'");
		КонецЕсли;
	...
	Иначе
		...
		Заголовок = НСтр("ru = 'Параметры блокировки работы с внешними ресурсами'; en = 'External resource lock settings'");
	КонецЕсли;
