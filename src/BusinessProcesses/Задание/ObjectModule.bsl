...
Процедура ПередЗаписью(Отказ)
	...
	Если ЗначениеЗаполнено(ГлавнаяЗадача)
		...
		ВызватьИсключение НСтр("ru = 'Собственная задача бизнес-процесса не может быть указана как главная задача.'; en = 'Business process task cannot be specified as the main task.'");
...
Функция НаименованиеЗадачиДляПроверки()
	...
	НаименованиеЗадачи = НСтр("ru = 'Проверить'; en = 'Verify'");
