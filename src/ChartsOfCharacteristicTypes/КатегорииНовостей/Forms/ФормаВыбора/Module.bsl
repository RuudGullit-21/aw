...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЭтотОбъект.ЛентаНовостей.Пустая() Тогда
		Элементы.Список.Подсказка = НСтр("ru = 'Категории без отбора, для всех лент новостей'; en = 'Categories without filter, for all news feeds'");
...
Процедура УстановитьУсловноеОформление()
	...
	// 2. Обновление с сервера: требуется обновление.
		...
		ОтборЭлемента.ВидСравнения = ВидСравненияКомпоновкиДанных.Равно;
		ОтборЭлемента.ПравоеЗначение = НСтр("ru = 'Требуется обновление'; en = 'Update required'"); // Идентификатор.
