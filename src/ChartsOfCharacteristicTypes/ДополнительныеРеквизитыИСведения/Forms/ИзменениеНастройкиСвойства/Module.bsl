...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.ЭтоДополнительноеСведение Тогда
		...
		Заголовок = НСтр("ru = 'Изменить настройку дополнительного сведения'; en = 'Change additional information settings'");
	Иначе
...
Функция ЗаписатьНаСервере()
	...
	НаименованиеЗадания = НСтр("ru = 'Изменение настройки дополнительного свойства'; en = 'Change additional property setting'");
