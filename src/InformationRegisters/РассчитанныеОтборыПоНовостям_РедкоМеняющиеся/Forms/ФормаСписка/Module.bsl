...
Процедура УстановитьУсловноеОформление()
	...
	// 1. Версия платформы, скрыта
		...
		Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Скрыта'; en = 'Hidden'"));
	...
	// 2. Версия платформы, видна
		...
		// Оформление
		Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Видна'; en = 'Visible'"));
	...
	// 3. Версия платформы, отбор не настроен - видна
		...
		// Оформление
		Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Отбор не настроен, видна'; en = 'Filter not set, visible'"));
