...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'Исполнители роли ""%1""'; en = 'Role performers ""%1""'"), Роль);
...
Процедура Подобрать(Команда)
	...
	Если РольДоступнаДляВнешнихПользователей И РольДоступнаДляПользователей Тогда
		...
		Выбор.Добавить("ВнешнийПользователь", НСтр("ru = 'Внешний пользователь'; en = 'External user'"));
		Выбор.Добавить("Пользователь", НСтр("ru = 'Пользователь'; en = 'User'"));
		ОписаниеОповещения = Новый ОписаниеОповещения("ПослеВыбораТипаПользователя", ЭтотОбъект);
		Выбор.ПоказатьВыборЭлемента(ОписаниеОповещения, НСтр("ru = 'Выберите тип пользователя'; en = 'Select user type'"));
