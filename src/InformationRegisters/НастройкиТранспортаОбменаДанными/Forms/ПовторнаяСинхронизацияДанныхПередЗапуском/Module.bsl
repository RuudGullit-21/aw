...
"Требуется открыть конфигуратор и обновить конфигурацию базы данных.'; en = 'Changes that have not been applied yet were received from the main node."
...
"Требуется открыть конфигуратор и обновить конфигурацию базы данных.'; en = 'Changes to be applied were received from the main node."
"Open Designer and update the database configuration.'");
	Иначе
...
"Подробности см. в журнале регистрации.'; en = 'Receiving data from the main node is completed with errors."
