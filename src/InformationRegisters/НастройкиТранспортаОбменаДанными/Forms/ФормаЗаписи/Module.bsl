...
Процедура ОповеститьПользователяОРезультатахПодключения(Знач ОшибкаПодключения)
	...
	ТекстПредупреждения = ?(ОшибкаПодключения, НСтр("ru = 'Не удалось установить подключение.'; en = 'Cannot connect.'"),
											   НСтр("ru = 'Подключение успешно установлено.'; en = 'Connection is successfully set.'"));
