...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.НетВерсий.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'Предыдущие версии отсутствуют: ""%1"".'; en = 'Previous versions are missing: ""%1"".'"), Строка(Ссылка));
...
"%1"
"Перейти на выбранную версию с отменой проведения?'; en = 'Cannot upgrade to a newer version as of:"
"%1"
"Transfer to the selected version and cancel posting?'"),
	...
	Иначе //Результат = "ВосстановлениеВыполнено"
		...
		ПоказатьОповещениеПользователя(
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'Восстановлена версия № %1.'; en = 'Version No.%1 is restored'"), ПредставлениеНомераВерсии),
...
Функция ИмяЭтойИнформационнойБазы()
	Возврат НСтр("ru = 'Эта программа'; en = 'This application'");
КонецФункции
