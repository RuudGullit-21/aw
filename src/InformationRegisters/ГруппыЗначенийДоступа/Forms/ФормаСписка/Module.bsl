...
Процедура ОбновитьДанныеРегистра(Команда)
	...
	Если ЕстьИзменения Тогда
		Текст = НСтр("ru = 'Обновление выполнено успешно.'; en = 'Update was successful.'");
	Иначе
		Текст = НСтр("ru = 'Обновление не требуется.'; en = 'Update is not required.'");
	КонецЕсли;
...
Процедура УстановитьУсловноеОформление()
	...
	ОформитьГруппуДанных(0, НСтр("ru = 'Стандартные значения доступа'; en = 'Default access values'"));
	ОформитьГруппуДанных(1, НСтр("ru = 'Обычные/внешние пользователи'; en = 'Standard/external users'"));
	ОформитьГруппуДанных(2, НСтр("ru = 'Обычные/внешние группы пользователей'; en = 'Standard/external user groups'"));
	ОформитьГруппуДанных(3, НСтр("ru = 'Группы исполнителей'; en = 'Performer groups'"));
	ОформитьГруппуДанных(4, НСтр("ru = 'Объекты авторизации'; en = 'Authorization objects'"));
