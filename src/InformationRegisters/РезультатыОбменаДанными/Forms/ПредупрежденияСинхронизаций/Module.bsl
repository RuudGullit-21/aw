...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Список.Параметры.УстановитьЗначениеПараметра("НепроведенныйДокумент", НСтр("ru = 'Непроведенный документ'; en = 'Unposted document'", ОбщегоНазначения.КодОсновногоЯзыка()));
...
Процедура ЖурналРегистрации(Команда)
	...
	УровниПредупреждений.Добавить(НСтр("ru = 'Ошибка'; en = 'Error'", ОбщегоНазначенияКлиент.КодОсновногоЯзыка()));
	УровниПредупреждений.Добавить(НСтр("ru = 'Предупреждение'; en = 'Warning'", ОбщегоНазначенияКлиент.КодОсновногоЯзыка()));
