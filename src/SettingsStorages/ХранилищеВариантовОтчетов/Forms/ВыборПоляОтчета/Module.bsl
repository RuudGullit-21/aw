...
Процедура УстановитьИмяКоллекции()
	...
	Если ИмяКоллекцииПолей = Неопределено Тогда		
		ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Некорректное значение параметра ""Режим"": ""%1"".'; en = 'Incorrect value of parameter ""Mode"": ""%1"".'"), Строка(Режим));		
	КонецЕсли;
...
Функция ДополнительноеПолеДетальныхЗаписей()
	...
	Поле.Представление = НСтр("ru = '<Детальные записи>'; en = '<Detailed records>'");
