...
"Выбрать этот варианта отчета?'; en = 'The selected report variant is marked for deletion."
...
Процедура ОткрытьВариантДляИзменения()
	...
	Если Не ПравоИзмененияВарианта(Вариант, ПолныеПраваНаВарианты) Тогда
		ТекстПредупреждения = НСтр("ru = 'Недостаточно прав для изменения варианта ""%1"".'; en = 'Insufficient rights to change variant ""%1"".'");
