...
Процедура ИмяФайлаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ДиалогОткрытияФайла.Заголовок = НСтр("ru = 'Укажите файл, в который надо экспортировать список лент новостей'; en = 'Specify the file to which it is necessary to export the news feed list'");
...
Процедура КомандаЭкспорт(Команда)
	...
	Если (ВРег(ЭтотОбъект.ФорматНовостей) <> ВРег("rss"))
		...
		Сообщение.Текст = НСтр("ru = 'Выберите правильный формат новостей'; en = 'Select valid news format'");
	...
	Если ПустаяСтрока(ЭтотОбъект.ИмяФайла) Тогда
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НСтр("ru = 'Укажите имя файла, куда сохранить список новостей'; en = 'Specify a file name to save the news list to'");
	...
	ПоказатьОповещениеПользователя(
		НСтр("ru = 'Экспорт завершен'; en = 'Export completed'"),
...
"Теперь в стороннем rss-агрегаторе можно выбрать из меню [Импортировать список лент новостей из OPML файла] и указать полученный файл (при условии, что rss-агрегатор поддерживает эту возможность).'; en = 'News feed list is successfully exported to the file."
	...
	ЗаписьХМЛ.ЗаписатьАтрибут("version", "1.1");
		ЗаписьХМЛ.ЗаписатьНачалоЭлемента("head");
			ЗаписьХМЛ.ЗаписатьНачалоЭлемента("title");
				ЗаписьХМЛ.ЗаписатьТекст(НСтр("ru = 'Список лент новостей (1С)'; en = 'Newsfeed list (1C)'"));
		...
		ЗаписьХМЛ.ЗаписатьНачалоЭлемента("body");
			ЗаписьХМЛ.ЗаписатьНачалоЭлемента("outline");
				ЗаписьХМЛ.ЗаписатьАтрибут("text", НСтр("ru = 'Новости 1С'; en = '1C news'"));
